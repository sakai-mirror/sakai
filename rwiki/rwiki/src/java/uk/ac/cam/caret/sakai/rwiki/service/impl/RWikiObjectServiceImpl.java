...
import uk.ac.cam.caret.sakai.rwiki.exception.CreatePermissionException;
import uk.ac.cam.caret.sakai.rwiki.exception.PermissionException;
import uk.ac.cam.caret.sakai.rwiki.exception.ReadPermissionException;
import uk.ac.cam.caret.sakai.rwiki.exception.UpdatePermissionException;
import uk.ac.cam.caret.sakai.rwiki.exception.VersionException;
...
public class RWikiObjectServiceImpl implements RWikiObjectService {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see uk.ac.cam.caret.sakai.rwiki.service.RWikiObjectService#getRWikiObject(java.lang.String,
	...
	public RWikiCurrentObject getRWikiObject(String name, String user,
		...
		try {
			...
			long finish = System.currentTimeMillis();
			RWikiServlet.printTimer("dao.GetRWikiObject: " + name + ", " + user
					+ ", " + realm, start, finish);
		}
	}
	 ...
	 * (non-Javadoc)
	 * 
	 * @see uk.ac.cam.caret.sakai.rwiki.service.RWikiObjectService#findByGlobalNameAndContents(java.lang.String,
	 *      java.lang.String, java.lang.String)
	 */
	...
	public boolean checkRead(RWikiObject rwo, String user) {
		...
		try {
			...
			long finish = System.currentTimeMillis();
			RWikiServlet.printTimer("canRead: " + progress, start, finish);
		}
	}
	...
	public boolean exists(String name, String realm) {
		...
		try {
			...
			long finish = System.currentTimeMillis();
			RWikiServlet.printTimer("Exists: " + name, start, finish);
	 ...
	 * (non-Javadoc)
	 * 
	 * @see uk.ac.cam.caret.sakai.rwiki.service.RWikiObjectService#findReferencingPages(java.lang.String)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see uk.ac.cam.caret.sakai.rwiki.service.RWikiObjectService#revert(java.lang.String,
	 ...
	 * (non-Javadoc)
	 * 
	 * @see uk.ac.cam.caret.sakai.rwiki.service.RWikiObjectService#getRWikiHistoryObject(java.lang.String,
	 *      int)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see uk.ac.cam.caret.sakai.rwiki.service.RWikiObjectService#findRWikiHistoryObjects(java.lang.String)
	 */
