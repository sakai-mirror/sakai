...
import uk.ac.cam.caret.sakai.rwiki.dao.RWikiPropertyDao;
import uk.ac.cam.caret.sakai.rwiki.model.RWikiProperty;
import uk.ac.cam.caret.sakai.rwiki.model.impl.RWikiPropertyImpl;
	...
	public RWikiProperty getProperty(final String name) {
	       long start = System.currentTimeMillis();
	        ...
	        return (RWikiProperty) found.get(0);
	            ...
	            RWikiServlet.printTimer("RWikiPropertyDaoImpl.getContentObject: " + name,start,finish);
	        }
	}
