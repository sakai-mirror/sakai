...
import uk.ac.cam.caret.sakai.rwiki.model.RWikiCurrentObjectContent;
import uk.ac.cam.caret.sakai.rwiki.model.RWikiObject;
import uk.ac.cam.caret.sakai.rwiki.model.RWikiObjectContent;
import uk.ac.cam.caret.sakai.rwiki.model.impl.RWikiCurrentObjectContentImpl;
	...
	public RWikiObjectContent getContentObject(final RWikiObject parent) {
	       long start = System.currentTimeMillis();
	        ...
	        return (RWikiObjectContent) found.get(0);
	            ...
	            RWikiServlet.printTimer("RWikiCurrentObjectContentDaoImpl.getContentObject: " + parent.getId(),start,finish);
	        }
	}
