...
import uk.ac.cam.caret.sakai.rwiki.model.RWikiHistoryObjectContent;
import uk.ac.cam.caret.sakai.rwiki.model.RWikiObject;
import uk.ac.cam.caret.sakai.rwiki.model.RWikiObjectContent;
import uk.ac.cam.caret.sakai.rwiki.model.impl.RWikiHistoryObjectContentImpl;
	...
	public RWikiObjectContent getContentObject(final RWikiObject parent) {
	       long start = System.currentTimeMillis();
	        ...
	        return (RWikiObjectContent) found.get(0);
	            ...
	            RWikiServlet.printTimer("RWikiHistroyObjectContentDaoImpl.getContentObject: " + parent.getId(),start,finish);
	        }
	}
