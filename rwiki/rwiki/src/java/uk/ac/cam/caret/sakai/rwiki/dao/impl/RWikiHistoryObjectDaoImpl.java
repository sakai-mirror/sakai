...
import uk.ac.cam.caret.sakai.rwiki.model.impl.RWikiHistoryObjectImpl;
...
public class RWikiHistoryObjectDaoImpl extends HibernateDaoSupport implements
    ...
    private Logger log;
    /**
     * @see uk.ac.cam.caret.sakai.rwiki.dao.RWikiHistoryObjectDao#update(uk.ac.cam.caret.sakai.rwiki.model.RWikiHistoryObject)
     */
    ...
    /**
     * @see uk.ac.cam.caret.sakai.rwiki.dao.RWikiHistoryObjectDao#createRWikiHistoryObject(uk.ac.cam.caret.sakai.rwiki.model.RWikiCurrentObject)
     */
    ...
    /**
     * @see uk.ac.cam.caret.sakai.rwiki.dao.RWikiHistoryObjectDao#getRWikiHistoryObject(uk.ac.cam.caret.sakai.rwiki.model.RWikiObject, int)
     */
    public RWikiHistoryObject getRWikiHistoryObject(final RWikiObject rwo, final int revision) {
    	        ...
    	        return (RWikiHistoryObject) proxyObject(found.get(0));
    	            ...
    	            RWikiServlet.printTimer("RWikiHistoryObjectDaoImpl.getRWikiHistoryObject: " + rwo.getName(),start,finish);
    	        }
    	     	
    }

    /**
     * @see uk.ac.cam.caret.sakai.rwiki.dao.RWikiHistoryObjectDao#findRWikiHistoryObjects(uk.ac.cam.caret.sakai.rwiki.model.RWikiObject)
     */
	public List findRWikiHistoryObjects(final RWikiObject reference) {
        ...
        return new ListProxy(found,this);
            ...
            long finish = System.currentTimeMillis();
            RWikiServlet.printTimer("RWikiHistoryObjectDaoImpl.getRWikiHistoryObjects: " + reference.getName(),start,finish);
        }
	}
