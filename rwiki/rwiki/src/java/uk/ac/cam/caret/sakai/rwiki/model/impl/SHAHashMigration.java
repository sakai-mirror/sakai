...
import uk.ac.cam.caret.sakai.rwiki.dao.RWikiObjectDao;
import uk.ac.cam.caret.sakai.rwiki.model.DataMigrationAgent;
...
public class SHAHashMigration implements DataMigrationAgent {
	...
	/* (non-Javadoc)
	 * @see uk.ac.cam.caret.sakai.rwiki.model.DataMigrationAgent#migrate(java.lang.String, java.lang.String)
	 */
