...
public class RWikiPermissionsImpl implements RWikiPermissions {
        ...
        /* (non-Javadoc)
         * @see uk.ac.cam.caret.sakai.rwiki.component.model.impl.RWikiPermissions#isGroupAdmin()
         */
        ...
        /* (non-Javadoc)
         * @see uk.ac.cam.caret.sakai.rwiki.component.model.impl.RWikiPermissions#setGroupAdmin(boolean)
         */
        ...
        /* (non-Javadoc)
         * @see uk.ac.cam.caret.sakai.rwiki.component.model.impl.RWikiPermissions#isGroupRead()
         */
        ...
        /* (non-Javadoc)
         * @see uk.ac.cam.caret.sakai.rwiki.component.model.impl.RWikiPermissions#setGroupRead(boolean)
         */
        ...
        /* (non-Javadoc)
         * @see uk.ac.cam.caret.sakai.rwiki.component.model.impl.RWikiPermissions#isGroupWrite()
         */
        ...
        /* (non-Javadoc)
         * @see uk.ac.cam.caret.sakai.rwiki.component.model.impl.RWikiPermissions#setGroupWrite(boolean)
         */
        public void setGroupWrite(boolean groupWrite) {
            this.permissions[GROUP_WRITE_INDEX] = groupWrite;
        }
        /* (non-Javadoc)
         * @see uk.ac.cam.caret.sakai.rwiki.component.model.impl.RWikiPermissions#isOwnerAdmin()
         */
        ...
        /* (non-Javadoc)
         * @see uk.ac.cam.caret.sakai.rwiki.component.model.impl.RWikiPermissions#setOwnerAdmin(boolean)
         */
        ...
        /* (non-Javadoc)
         * @see uk.ac.cam.caret.sakai.rwiki.component.model.impl.RWikiPermissions#isOwnerRead()
         */
        ...
        /* (non-Javadoc)
         * @see uk.ac.cam.caret.sakai.rwiki.component.model.impl.RWikiPermissions#setOwnerRead(boolean)
         */
        ...
        /* (non-Javadoc)
         * @see uk.ac.cam.caret.sakai.rwiki.component.model.impl.RWikiPermissions#isOwnerWrite()
         */
        ...
        /* (non-Javadoc)
         * @see uk.ac.cam.caret.sakai.rwiki.component.model.impl.RWikiPermissions#setOwnerWrite(boolean)
         */
        ...
        /* (non-Javadoc)
         * @see uk.ac.cam.caret.sakai.rwiki.component.model.impl.RWikiPermissions#isPublicRead()
         */
        ...
        /* (non-Javadoc)
         * @see uk.ac.cam.caret.sakai.rwiki.component.model.impl.RWikiPermissions#setPublicRead(boolean)
         */
        ...
        /* (non-Javadoc)
         * @see uk.ac.cam.caret.sakai.rwiki.component.model.impl.RWikiPermissions#isPublicWrite()
         */
        ...
        /* (non-Javadoc)
         * @see uk.ac.cam.caret.sakai.rwiki.component.model.impl.RWikiPermissions#setPublicWrite(boolean)
         */
