...
import uk.ac.cam.caret.sakai.rwiki.util.XmlEscaper;
...
public class PublicPageLinkRendererImpl implements PageLinkRenderer {
    ...
    /*
     *  (non-Javadoc)
     * @see uk.ac.cam.caret.sakai.rwiki.service.PageLinkRenderer#isCachable()
     */
	...
	/*
	 *  (non-Javadoc)
	 * @see uk.ac.cam.caret.sakai.rwiki.service.PageLinkRenderer#canUseCache()
	 */
