...
package uk.ac.cam.caret.sakai.rwiki.macros;
...
import uk.ac.cam.caret.sakai.rwiki.radeox.service.impl.SpecializedRenderContext;
...
public class ImageMacro extends BaseMacro {
	...
	throws IllegalArgumentException, IOException {
	    ...
	    RWikiSecurityService securityService = context.getSecurityService();
		...
		if (params.getLength() > 0) {
			...
			if ( imageName.startsWith("http://") || imageName.startsWith("https://") || imageName.startsWith("ftp://") )
