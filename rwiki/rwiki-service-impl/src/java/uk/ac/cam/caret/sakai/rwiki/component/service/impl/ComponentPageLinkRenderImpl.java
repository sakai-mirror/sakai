...
public class ComponentPageLinkRenderImpl implements PageLinkRenderer {
	...
	/**
	 * @param anchorURLFormat The anchor URL Format to set, param 0 is the pagename, 1 is the anchor
	 */
	...
	/**
	 * @param standardURLFormat The standard URL Format to set, param 0 is the pagename
	 */
	...
	/**
	 * @param urlFormat The urlFormat to set use to generate link html
	 */
