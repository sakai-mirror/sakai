/**********************************************************************************
 *
 * $Header: /cvs/sakai2/common/common-composite-component-data/src/java/org/sakaiproject/component/common/manager/PersistableImpl.java,v 1.1 2005/05/11 15:41:15 lance.indiana.edu Exp $
 *
 ***********************************************************************************
 *
...
public abstract class PersistableImpl implements Persistable
{
  ...
  /**
   * @param id The id surrogateKey to set.
   */
  ...
  /**
   * @param version The version (optimistic lock) to set.
   */
