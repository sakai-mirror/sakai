...
<f:view>
<sakaix:view title="inputColor tag - Sakai 2.0 JSF example">
...
<sakaix:script contextBase="/sakai-jsf-resource/" path="/inputColor/inputColor.js"/>
...
<h:form id="colorForm">
  Pick color:
  <sakaix:inputColor value="" id="myInputColorId"/>
...
<pre>
    ...
    Pick color:
    &lt;</font><font COLOR="#800080"><B>sakaix:inputColor</B></font><font COLOR="#000000"> </font><font COLOR="#800000">value</font><font COLOR="#000000">=</font><font COLOR="#0000ff">""</font><font COLOR="#000000"> </font><font COLOR="#800000">size</font><font COLOR="#000000">=</font><font COLOR="#0000ff">"10"</font><font COLOR="#000000"> </font><font COLOR="#800000">id</font><font COLOR="#000000">=</font><font COLOR="#0000ff">"myInputColorId"</font><font COLOR="#000000">/&gt;
