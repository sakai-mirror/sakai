/**********************************************************************************
*
* $Header: /cvs/sakai2/legacy/tool-support/src/java/org/sakaiproject/cheftool/menu/Menu.java,v 1.1 2005/04/12 03:11:38 ggolden.umich.edu Exp $
*
***********************************************************************************
*
...
public class Menu implements MenuItem
{
	...
	public Menu(VelocityPortlet p, RunData r, String action)
	{
		super();
	}
	// CHEF 1.x support
	...
	*/
	public Menu(String title, String icon, boolean enabled)
	{
		m_title = title;
		m_icon = icon;
		m_enabled = enabled;
	...
	* Construct a menu (good for sub-menus).
	*/
	public Menu(String title, String icon, boolean enabled, String form)
	{
		m_title = title;
		m_icon = icon;
		m_enabled = enabled;
