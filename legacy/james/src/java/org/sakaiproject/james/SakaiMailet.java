/**********************************************************************************
 *
 * $Header: /cvs/sakai2/legacy/james/src/java/org/sakaiproject/james/SakaiMailet.java,v 1.2 2005/06/05 03:08:58 ggolden.umich.edu Exp $
 *
 ***********************************************************************************
 *
		...
		try
		{
			...
			while (it.hasNext())
			{
				...
				try
				{
					...
					if (Logger.isInfoEnabled()) Logger.info(this + ": " + id + " : checking to: " + recipient);
					...
					if (Logger.isInfoEnabled()) Logger.info(this + ": " + id + " : delivered to:" + mailId);
				...
				{
					if (Logger.isInfoEnabled()) Logger.info(this + ": " + id + " : " + e);
				}
			}
		}
		finally
