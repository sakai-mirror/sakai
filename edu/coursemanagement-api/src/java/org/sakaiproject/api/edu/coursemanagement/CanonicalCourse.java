...
/**
 * A Canonical Course is a general course that exists across terms. It is an abstract course. One way of thinking about canonical courses is that they are the set of all possible courses that could be offered at a university. Not that all courses are not
 * offered every term, which is why there is a course offering (see below). This class provides access to a title, catalog description, course number, default credits, a list of topics, a list of equivalent courses, and a list of prerequisites. From a
 * structural viewpoint, the class includes a canonical course type, a unique id, a parent canonical course, child canonical courses, and course offerings based on this course.
 * <ul>
 * <li>A title [String]
