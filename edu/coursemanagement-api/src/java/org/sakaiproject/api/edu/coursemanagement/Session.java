 ...
 *	a schedule of events, such as holidays.
 *	<ul>
 *	<li>A title  [String]
...
public interface Session {
	...
	/**
	 * Get the year of this session.  Note that this could
	 * be of the form "2005-2006" rather than a simple
	 * year string.
	 * 
	 * @return year string
	 */
	...
	/**
	 * Return true if this is the current session.  The session is
	 * current if today's date falls between the start and end
	 * times.
	 * 
