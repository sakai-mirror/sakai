...
public class CourseSectionTypeImpl implements CourseSectionType, Serializable {
    ...
    private Long courseSectionTypeId;
    ...
    public Long getCourseSectionTypeId() {
    	return this.courseSectionTypeId;
	}

	public void setCourseSectionTypeId(Long courseSectionTypeId) {
		this.courseSectionTypeId = courseSectionTypeId;
	}
    ...
    public boolean equals(Object rhs)
    {
        if (rhs == null)
            return false;
        if (! (rhs instanceof CourseSectionTypeImpl))
            return false;
        CourseSectionTypeImpl that = (CourseSectionTypeImpl) rhs;
        if (this.getCourseSectionTypeId() == null || that.getCourseSectionTypeId() == null)
            return false;
        return (this.getCourseSectionTypeId().equals(that.getCourseSectionTypeId()));
    }
    ...
    public int hashCode()
    {
        ...
        {
            int result = 17;
            int courseSectionTypeIdValue = this.getCourseSectionTypeId() == null ? 0 : this.getCourseSectionTypeId().hashCode();
            result = result * 37 + courseSectionTypeIdValue;
