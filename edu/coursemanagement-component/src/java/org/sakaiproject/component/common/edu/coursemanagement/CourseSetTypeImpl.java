...
import org.sakaiproject.api.edu.coursemanagement.CourseSetType;

public class CourseSetTypeImpl implements CourseSetType, Serializable {
    ...
    public Long getCourseSetTypeId() {
    	return this.courseSetTypeId;
	}

	public void setCourseSetTypeId(Long courseSetTypeId) {
		this.courseSetTypeId = courseSetTypeId;
	}
    ...
    public boolean equals(Object rhs)
    {
        if (rhs == null)
            return false;
        if (! (rhs instanceof CourseSetTypeImpl))
            return false;
        CourseSetTypeImpl that = (CourseSetTypeImpl) rhs;
        if (this.getCourseSetTypeId() == null || that.getCourseSetTypeId() == null)
            return false;
        return (this.getCourseSetTypeId().equals(that.getCourseSetTypeId()));
    }
    ...
    public int hashCode()
    {
        ...
        {
            int result = 17;
            int courseSetTypeIdValue = this.getCourseSetTypeId() == null ? 0 : this.getCourseSetTypeId().hashCode();
            result = result * 37 + courseSetTypeIdValue;
