 ...
 *
 * $Header: /opt/CVS/osp2.x/homesComponent/src/java/org/theospi/metaobj/security/impl/sakai/RoleWrapper.java,v 1.1 2005/06/29 18:36:41 chmaurer Exp $
 * $Revision$
 * $Date$
 */
...
public class RoleWrapper implements OspRole {
   ...
   public boolean equals(Object o) {
      ...
      if (!(o instanceof RoleWrapper)) return false;

      final RoleWrapper roleWrapper = (RoleWrapper) o;

      if (id != null ? !id.equals(roleWrapper.id) : roleWrapper.id != null) return false;
