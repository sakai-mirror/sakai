 ...
 *
 * $Header: /opt/CVS/osp2.x/homesComponent/src/java/org/theospi/metaobj/repository/PersistentNode.java,v 1.1 2005/06/29 18:36:41 chmaurer Exp $
 * $Revision: 1.1 $
...
public interface PersistentNode extends Node {
   ...
   //TODO Ideally, these methods should fail atomically when something goes wrong.
   ...
   /**
    * create just the TreeNode of this already created object
    * @param newNode
    * @param displayName
    * @return
    */
