/**********************************************************************************
*
* $Header: /cvs/sakai/util/src/java/org/sakaiproject/util/Validator.java,v 1.11 2004/09/21 01:42:45 janderse.umich.edu Exp $
*
***********************************************************************************
*
...
//	protected static final String ESCAPE_URL = "#%?&='\"+ ";
	...
	/**
	* Return a string based on value that is "safe" to embed into HTML; newlines are escaped as "<br />".
	* Markup, amperstand, quote are escaped. Whitespace is not.
	...
	*/
	...
	/**
	* Return a string based on value that is "safe" to embed into HTML; NEWLINES ARE LEFT AS-IS.
	* Markup, amperstand and quotes are escaped.  Whitespace and newlines are not.
	* @param value The string to escape.
	* @return value fully escaped for HTML.
	*/
	public static String escapeHtmlPreserveNewlines(String value)
	{
	...
	/**
	* Escape text for a textarea.
	*/
	public static String escapeHtmlTextarea(String value)
	{
		return escapeHtmlPreserveNewlines(value);
	}
	...
	{
		return FormattedText.escapeHtmlFormattedTextPreserveNewlines(value);
	}
	...
	/**
	* Return a string based on value that is "safe" to embed into HTML.
	* Markup, amper, quote and (if not raw) newline are escaped.  Whitespace is not.
	* @param value The string to escape.
	* @param escapeNewlines Whether to escape newlines as "<br />"
	* @return value fully escaped for HTML.
	*/
	private static String escapeHtml(String value, boolean escapeNewlines)
	{
	...
	* For example, trim("Hello <b>World</b>!", 7) returns "Hello <b>W</b>..."
