/**********************************************************************************
*
* $Header: /cvs/sakai/util/src/java/org/sakaiproject/util/storage/BaseXmlFileStorage.java,v 1.13 2004/10/01 00:13:36 ggolden.umich.edu Exp $
*
***********************************************************************************
*
...
public class BaseXmlFileStorage
{
	...
	*/
	...
	protected Document createDocument()
	{
		...
		if (m_containerTagName == null)
		{
			Enumeration enum = ((Container) m_store.get("")).contained.elements();
			while (enum.hasMoreElements())
			{
				Resource entry = (Resource) enum.nextElement();
		...
		{
			Enumeration enum = m_store.elements();
			while (enum.hasMoreElements())
			{
	...
	*/
	...
	public List getResources(String container, Time afterDate, int limitedToLatest, String draftsForId)
	{
		...
		if ((limitedToLatest == 0) && (afterDate == null) && ("*".equals(draftsForId)))
		{
			return all;
		}
