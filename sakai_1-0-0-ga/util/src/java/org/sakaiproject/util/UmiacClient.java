/**********************************************************************************
*
* $Header: /cvs/sakai/util/src/java/org/sakaiproject/util/UmiacClient.java,v 1.11 2004/10/06 05:05:28 ggolden.umich.edu Exp $
*
***********************************************************************************
*
	...
	implements CacheRefresher
{
	...
	* 5 - SPRING/SUMMER
	*/
	public Vector getInstructorClassess (String id, String term_year, String term)
		throws IdUnusedException
	{
