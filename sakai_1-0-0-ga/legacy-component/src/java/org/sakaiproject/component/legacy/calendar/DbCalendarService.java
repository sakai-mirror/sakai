/**********************************************************************************
*
* $Header: /cvs/sakai/legacy-component/src/java/org/sakaiproject/component/legacy/calendar/DbCalendarService.java,v 1.9 2004/10/07 08:08:09 janderse.umich.edu Exp $
*
***********************************************************************************
*
		...
		*/
		public DbStorage(StorageUser user)
		{
			...
			super(m_cTableName, "CALENDAR_ID", m_rTableName, "EVENT_ID", "CALENDAR_ID",
					"EVENT_START", /* owner, draft */null, null, FIELDS, m_locksInDb, "calendar", "event", user, m_sqlService);
