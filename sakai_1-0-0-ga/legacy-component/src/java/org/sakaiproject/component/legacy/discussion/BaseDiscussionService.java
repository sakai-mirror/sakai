/**********************************************************************************
*
* $Header: /cvs/sakai/legacy-component/src/java/org/sakaiproject/component/legacy/discussion/BaseDiscussionService.java,v 1.17 2004/09/30 20:20:02 ggolden.umich.edu Exp $
*
***********************************************************************************
*
		...
		*/
		public Element toXml(Document doc, Stack stack)
		{
			...
			for (int i = 0; i < m_categories.size(); i++)
			{
				...
				cElement.setAttribute("name", (String) m_categories.elementAt(i));				
			}
