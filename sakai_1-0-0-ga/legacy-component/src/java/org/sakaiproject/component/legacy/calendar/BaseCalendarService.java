/**********************************************************************************
*
* $Header: /cvs/sakai/legacy-component/src/java/org/sakaiproject/component/legacy/calendar/BaseCalendarService.java,v 1.33 2004/10/12 19:32:49 ggolden.umich.edu Exp $
*
***********************************************************************************
*
	...
	*******************************************************************************/
	...
	public String merge(String siteId, Element root, String archivePath, String fromSiteId, Map attachmentNames, HashMap userIdTrans, Set userListAllowImport)
	{
		...
		try
		{
			...
			// TODO: calendar props and attributes? -ggolen
			...
			for (int i2 = 0; i2 < length2; i2++)
			{
				...
				if (child2.getNodeType() == Node.ELEMENT_NODE)
				{
					...
					{
						// TODO: merge in the calendar stuff
	...
	public class BaseCalendarEventEdit implements CalendarEventEdit, SessionStateBindingListener
	{
		...
		*/
		public String getDescriptionFormatted()
		{
			...
			String desc = m_properties.getPropertyFormatted(ResourceProperties.PROP_DESCRIPTION+"-formatted");
		...
		*/
		public void setDescriptionFormatted(String description)
		{
			...
			m_properties.addProperty(ResourceProperties.PROP_DESCRIPTION+"-formatted", description);
