/**********************************************************************************
*
* $Header: /cvs/sakai/legacy-component/src/java/org/sakaiproject/component/legacy/news/BasicNewsService.java,v 1.10 2004/08/24 20:35:23 zqian.umich.edu Exp $
*
***********************************************************************************
*
...
/**
* <p>BasicNewsService extends the BaseMessageService for the specifics of News.</p>

looking good!  Put an entry in chef_tools.xreg, and a parallel entry in
the ChefJetspeedConfigurationService, and your service entries in
chef_dev_local_resources.properties, chef_dev, ctng_cluster_testg and
ctng_resources.properties.
...
public class BasicNewsService implements NewsService
{
	...
	*/
	...
	/**
	* <p>Checks whether channel is cached. If not or if it's expired,
	* retrieve the feed and update the cache</p>
	* @param source The url for the news feed
	* @exception NewsConnectionException, for errors making the connection.
	* @exception NewsFormatException, for errors in the URL or errors parsing the feed.
	*/
	...
	*******************************************************************************/
	...
	public class BasicNewsItem implements NewsItem
	{
		...
		/**
		* Construct.
		* @param title The headline of the item
		* @param description The body of the item
		* @param link The URL for a longer version of the item
		* @param pubdate The date/time at which the item was published
		*/
		...
		* @param link The URL where the complete story can be found.
		*/
		...
		* @param description The description (or body) of the NewsItem.
		*/
	...
	*******************************************************************************/
	...
	public class BasicNewsChannel implements NewsChannel
	{
		...
		/**
		* Construct.
		* @param source The URL from which the feed can be obtained
		* @exception NewsConnectionException, for errors making the connection.
		* @exception NewsFormatException, for errors in the URL or errors parsing the feed.
		*/
		...
		private void initChannel(String source) throws NewsConnectionException, NewsFormatException
		{
			...
			catch (MalformedURLException e)
			{
				if (m_logger.isDebugEnabled())
					m_logger.debug(this +".initChannel(" + source + ") bad url: " + e.getMessage());
			...
			catch (IOException e)
			{
				if (m_logger.isDebugEnabled())
					m_logger.debug(
						this +".initChannel(" + source + ") constructor: couldn't connect: " + e.getMessage());
			...
			{
				if (m_logger.isDebugEnabled())
					m_logger.debug(this +".initChannel(" + source + ") constructor: null document");
		...
		* The parameter can be a String reference or a NewsChannel object (otherwise
	...
	* @param source The url for the feed.
