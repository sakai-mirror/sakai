/**********************************************************************************
*
* $Header: /cvs/sakai/legacy-component/src/java/org/sakaiproject/component/legacy/notification/EmailSiteEmailNotification.java,v 1.5 2004/06/22 03:14:00 ggolden Exp $
*
***********************************************************************************
*
...
/**
* <p>EmailSiteEmailNotification fills the notification message with details from the email message that triggered
	...
	extends SiteEmailNotification
{
	...
	*/
	...
	/**
	* Do the notification.  Well, since this is on the way out, don't to the notification. -ggolden
