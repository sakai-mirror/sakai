/**********************************************************************************
*
* $Header: /cvs/sakai/legacy-component/src/java/org/sakaiproject/component/legacy/digest/BaseDigestService.java,v 1.21 2004/10/14 14:28:11 ggolden.umich.edu Exp $
*
***********************************************************************************
*
	...
	protected void send(String id, List msgs, TimeRange period)
	{
		...
		try
		{
			...
			String subject = ServerConfigurationService.getString("ui.service", "Sakai")
					+ " notification digest for " + period.firstTime().toStringLocalDate();
			...
			// tag
			body.append("This automatic notification message digest was sent to users of "
						+ ServerConfigurationService.getString("ui.service","Sakai")
						+ " ("
						+ ServerConfigurationService.getServerUrl()
						+ ")" + "\n"
						+ "You can modify your notification preferences in your MyWorkspace.\n");
