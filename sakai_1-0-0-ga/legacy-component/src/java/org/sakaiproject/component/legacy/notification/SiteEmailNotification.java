/**********************************************************************************
*
* $Header: /cvs/sakai/legacy-component/src/java/org/sakaiproject/component/legacy/notification/SiteEmailNotification.java,v 1.7 2004/09/15 17:33:00 ggolden.umich.edu Exp $
*
***********************************************************************************
*
	...
	*/
	protected List getRecipients(Event event)
	{
		...
		try
		{
			...
			if (site.getStatus() == Site.SITE_STATUS_UNPUBLISHED)
			{
