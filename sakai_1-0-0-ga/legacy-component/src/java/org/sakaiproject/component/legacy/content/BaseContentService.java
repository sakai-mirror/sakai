/**********************************************************************************
*
* $Header: /cvs/sakai/legacy-component/src/java/org/sakaiproject/component/legacy/content/BaseContentService.java,v 1.29 2004/10/14 22:23:04 janderse.umich.edu Exp $
*
***********************************************************************************
*
...
public abstract class BaseContentService implements ContentHostingService, CacheRefresher
{
	...
	*******************************************************************************/
	...
	public void init()
	{
		try
		{
			m_logger.info(this +".init(ServletConfig): site-quota: " + m_siteQuota);
	...
	*/
	...
	public String archive(String siteId, Document doc, Stack stack, String archivePath, ReferenceVector attachments)
	{
		...
		catch (Exception any)
		{
			...
			m_logger.warn(this +".archve: exception archiving collection: " + siteId + ": ", any);
		}
	...
	*/
		...
		throws PermissionException, InconsistentException, IdInvalidException, OverQuotaException
	{
		...
		// transfer from the XML read object to the edit Note: this replaces the properties completely
		edit.set(resourceFromXml);
