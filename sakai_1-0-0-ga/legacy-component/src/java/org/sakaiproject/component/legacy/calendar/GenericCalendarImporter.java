/**********************************************************************************
*
* $Header: /cvs/sakai/legacy-component/src/java/org/sakaiproject/component/legacy/calendar/GenericCalendarImporter.java,v 1.5 2004/07/07 13:02:24 brettm.umich.edu Exp $
*
***********************************************************************************
*
...
import org.sakaiproject.component.legacy.calendar.readers.CSVReader;
import org.sakaiproject.component.legacy.calendar.readers.MeetingMakerReader;
import org.sakaiproject.component.legacy.calendar.readers.OutlookReader;
...
public class GenericCalendarImporter implements CalendarImporterService
{
	...
	public class PrototypeEvent implements CalendarEventEdit
	{
		...
		/* (non-Javadoc)
		 * @see org.sakaiproject.service.legacy.calendar.CalendarEvent#getRange()
		 */
		...
		/* (non-Javadoc)
		 * @see org.sakaiproject.service.legacy.calendar.CalendarEvent#getDisplayName()
		 */
		...
		/* (non-Javadoc)
		 * @see org.sakaiproject.service.legacy.calendar.CalendarEvent#getDescription()
		 */
		...
		/* (non-Javadoc)
		 * @see org.sakaiproject.service.legacy.calendar.CalendarEvent#getType()
		 */
		...
		/* (non-Javadoc)
		 * @see org.sakaiproject.service.legacy.calendar.CalendarEvent#getLocation()
		 */
		...
		/* (non-Javadoc)
		 * @see org.sakaiproject.service.legacy.calendar.CalendarEvent#getField(java.lang.String)
		 */
		...
		/* (non-Javadoc)
		 * @see org.sakaiproject.service.legacy.calendar.CalendarEvent#getCalendarReference()
		 */
		...
		/* (non-Javadoc)
		 * @see org.sakaiproject.service.legacy.calendar.CalendarEvent#getRecurrenceRule()
		 */
		...
		/* (non-Javadoc)
		 * @see org.sakaiproject.service.legacy.calendar.CalendarEventEdit#setRange(org.sakaiproject.service.legacy.time.TimeRange)
		 */
		...
		/* (non-Javadoc)
		 * @see org.sakaiproject.service.legacy.calendar.CalendarEventEdit#setDisplayName(java.lang.String)
		 */
		...
		/* (non-Javadoc)
		 * @see org.sakaiproject.service.legacy.calendar.CalendarEventEdit#setDescription(java.lang.String)
		 */
		...
		/* (non-Javadoc)
		 * @see org.sakaiproject.service.legacy.calendar.CalendarEventEdit#setType(java.lang.String)
		 */
		...
		/* (non-Javadoc)
		 * @see org.sakaiproject.service.legacy.calendar.CalendarEventEdit#setLocation(java.lang.String)
		 */
		...
		/* (non-Javadoc)
		 * @see org.sakaiproject.service.legacy.calendar.CalendarEventEdit#setField(java.lang.String, java.lang.String)
		 */
		...
		/* (non-Javadoc)
		 * @see org.sakaiproject.service.legacy.calendar.CalendarEventEdit#setRecurrenceRule(org.sakaiproject.service.legacy.calendar.RecurrenceRule)
		 */
					...
					else
					{
							...
							.equals(column.getPropertyName()))
						{
							...
							try
							{
								...
								mapCellValue = new Integer(durationMinutes);
							}
