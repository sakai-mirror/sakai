/**********************************************************************************
*
* $Header: /cvs/sakai/legacy-component/src/java/org/sakaiproject/component/legacy/announcement/XmlFileAnnouncementService.java,v 1.11 2004/09/03 16:17:20 ggolden.umich.edu Exp $
*
***********************************************************************************
*
...
/**
* <p>XmlFileAnnouncementService fills out the BaseAnnouncementService with a in-memory xml file backed up
...
*/
public class XmlFileAnnouncementService extends BaseAnnouncementService
{
	/** A full path and file name to the storage file. */
	protected String m_storagePath = "db/announcements.xml";
	...
	*******************************************************************************/
	...
	/**
	* Covers for the BaseXmlFileStorage, providing Announcement parameters
	*/
	protected class XmlFileStorage extends BaseXmlFileStorage implements Storage
	{
		...
		*/
		...
		{
			super(m_storagePath, "announcements", "channel", "message", user);
