/**********************************************************************************
*
* $Header: /cvs/sakai/faces/src/java/com/sun/faces/config/ManagedBeanFactory.java,v 1.3 2004/09/30 20:20:29 ggolden.umich.edu Exp $
*
***********************************************************************************
*
...
/*
 * $Id: ManagedBeanFactory.java,v 1.3 2004/09/30 20:20:29 ggolden.umich.edu Exp $
 */
...
public class ManagedBeanFactory extends Object {
    ...
    private boolean hasValidLifespan(String value) {
		...
		// TODO: (done) for Sakai - "tool" scope can see anything tool and above
		//if the managed bean's scope is "tool" it is able to refer
		//to objects in other "tool", "session", "application", or "none" scopes
		if (scope.equalsIgnoreCase("tool")) {
			if (valueScope != null) {
        ...
        if (scope.equalsIgnoreCase(RIConstants.SESSION)) {
            if (valueScope != null) {
                ...
                // TODO: (done) we don't want tool, either
				if (valueScope.equalsIgnoreCase("tool")) {
					return false;
				}
            }
            return true;
