/**********************************************************************************
*
* $Header: /cvs/sakai/faces/src/java/com/sun/faces/application/ApplicationImpl.java,v 1.5 2004/09/30 20:19:37 ggolden.umich.edu Exp $
*
***********************************************************************************
*
...
/*
 * $Id: ApplicationImpl.java,v 1.5 2004/09/30 20:19:37 ggolden.umich.edu Exp $
 */
...
//
    ...
    synchronized public Object createAndMaybeStoreManagedBeans(FacesContext context,
		...
		// TODO: (done) here's the only change for Sakai!
		else if (scope.equalsIgnoreCase("tool"))
		{
			SessionState state = PortalService.getCurrentToolState();
			state.setAttribute(managedBeanName, bean);
		}
