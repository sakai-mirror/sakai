/**********************************************************************************
*
* $Header: /cvs/sakai/chef-tool/src/java/org/sakaiproject/tool/web/IFrameAction.java,v 1.12 2004/09/30 20:20:29 ggolden.umich.edu Exp $
*
***********************************************************************************
*
	...
	{		
		...
		{	
			...
			else if ("worksite".equals(special))
			{
				...
				{
					Site s = SiteService.getSite(siteId);
					url = StringUtil.trimToNull(s.getInfoUrlFull());
					
					// if this is null, use the site description instead
					if (url == null)
					{
						url="";
					}
