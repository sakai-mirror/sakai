/**********************************************************************************
*
* $Header: /cvs/sakai/chef-tool/src/java/org/sakaiproject/tool/calendar/PrintFileGenerator.java,v 1.9 2004/07/09 19:48:35 ggolden.umich.edu Exp $
*
***********************************************************************************
*
...
public class PrintFileGenerator
{
	...
	private static class SingleDayLayoutTable
	{
		 ...
		 * @param timeRange
		 * @param maxNumberOverlappingEvents
		 * @param timeslotInMinutes
		 */
