/**********************************************************************************
*
* $Header: /cvs/sakai/chef-tool/src/java/org/sakaiproject/tool/helper/PermissionsAction.java,v 1.7 2004/09/30 20:20:51 ggolden.umich.edu Exp $
*
***********************************************************************************
*
...
public class PermissionsAction
{
	...
	*/
										...
										SessionState state)
	{
		...
		// get the real locked for editing
		...
		if (rolesAbilities == null)
		{
			...
			// get this resource's Realms, without it's own realm
			...
			for (Iterator iRoles = roles.iterator(); iRoles.hasNext(); )
			{
				...
				rolesAbilities.put(role.getId(), roleAbilities(role.getId(), realms));
			}
		}
	...
	*/
	...
	/**
	* Collect all the abilities of a given role in the context of a given resource,
	* considering all the realms involved but NOT that of the resource itself.
	* @param roleId The role id.
	* @param realms The list of Realms to consider.
	* @return Set (String) of abilities / lock names this role has for this resource.
	*/
	private static Set roleAbilities(String roleId, List realms)
	{
		// the set of abilities that we find for this role
