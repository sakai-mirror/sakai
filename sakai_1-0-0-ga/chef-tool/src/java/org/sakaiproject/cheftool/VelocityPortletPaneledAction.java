/**********************************************************************************
*
* $Header: /cvs/sakai/chef-tool/src/java/org/sakaiproject/cheftool/VelocityPortletPaneledAction.java,v 1.40 2004/09/30 20:21:43 ggolden.umich.edu Exp $
*
***********************************************************************************
*
...
//		}
	...
	*/
	...
	protected void setVmStdRef(HttpServletRequest request, HttpServletResponse response)
	{
		...
		if (tool != null)
		{
			String siteSkin = StringUtil.trimToNull(tool.getContainingPage().getContainingSite().getSkin());
			if (siteSkin != null)
			{
				skin = siteSkin;
			}
