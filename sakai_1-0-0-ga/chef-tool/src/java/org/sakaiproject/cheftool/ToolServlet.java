/**********************************************************************************
*
* $Header: /cvs/sakai/chef-tool/src/java/org/sakaiproject/cheftool/ToolServlet.java,v 1.15 2004/09/30 20:21:43 ggolden.umich.edu Exp $
*
***********************************************************************************
*
...
//		}
	...
	*******************************************************************************/
	...
	{
		return ((ParameterParser) req.getAttribute(ATTR_PARAMS)).getString(ActionURL.PARAM_PID);
	}
	...
	protected SessionState getState(HttpServletRequest req)
	{
		...
		return UsageSessionService.getSessionState(key);
	}
	...
	protected void prepState(HttpServletRequest req, HttpServletResponse res)
	{
		...
		// lets try to sync on the http session.  That's more than we need but not too bad. -ggolden
		HttpSession session = (HttpSession) CurrentService.getInThread(HttpSession.class.getName());
