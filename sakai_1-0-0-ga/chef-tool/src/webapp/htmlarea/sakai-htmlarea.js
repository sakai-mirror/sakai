/**********************************************************************************
*
* $Header: /cvs/sakai/chef-tool/src/webapp/htmlarea/sakai-htmlarea.js,v 1.14 2004/10/01 01:07:20 janderse.umich.edu Exp $
*
***********************************************************************************
@license@
**********************************************************************************/
...
// be called like:
// <script type="text/javascript" defer="1">chef_setupformattedtextarea("MyTextareaID");</script>
...
else
{
	document.msg_formattedtextnotsupported = "<br>The rich text editor is not supported by the browser you are using.<br>" 
		+ "Please see <a href='/sakai-chef-tool/htmlarea/reference.html#supportedbrowsers' target='_blank'>"
...
{
	chef_setupformattedtext(textarea_id, false);
}


// textarea_id - The HTML id of the HTML textarea 
// that should be turned into a full-featured HTML document editing widget
function chef_setuphtmldocumenttextarea(textarea_id)
{
	chef_setupformattedtext(textarea_id, true);
}


function chef_setupformattedtext(textarea_id, fulldocumentediting)
{
	...
	if (!fulldocumentediting)
	{
		// only enable certain formatted text controls, not all possible HTML formatted text controls
		config.toolbar = [
		[ "fontname", "space",
		  "fontsize", "space",
		  "forecolor", "space",
	...
	if (!fulldocumentediting)
	{
		...
		// The widget expects like breaks to be encoded as "<br />".
		// A plain textarea just uses newlines for line breaks.
