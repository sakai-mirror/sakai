/**********************************************************************************
*
* $Header: /cvs/sakai/framework-component/src/java/org/sakaiproject/component/framework/config/BasicConfigurationService.java,v 1.36 2004/10/13 02:14:44 ggolden.umich.edu Exp $
*
***********************************************************************************
*
...
public class BasicConfigurationService implements ServerConfigurationService
{
	...
	protected void loadRegistrationFile(File file, Map categories)
	{
		...
		for (int i = 0; i < rootNodesLength; i++)
		{
			...
			if (rootElement.getTagName().equals("tool"))
			{
				...
				BaseToolRegistration reg = new BaseToolRegistration(id, title, description, url);
				...
				for (int k = 0; k < kidsLength; k++)
				{
					...
					// for category
					else if (kidElement.getTagName().equals("category"))
					{
						String name = StringUtil.trimToNull(kidElement.getAttribute("name"));
						if (name != null)
						{
							reg.addCategory(name);
						}
					}
				}
	...
	*******************************************************************************/
	...
	public class BaseToolRegistration implements ToolRegistration
	{
		...
		*/
		public BaseToolRegistration(String id, String title, String description, String url)
		{
			// set the id
			m_id = id;
