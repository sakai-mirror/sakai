/**********************************************************************************
*
* $Header: /cvs/sakai/service/src/java/org/sakaiproject/service/framework/sql/SqlService.java,v 1.8 2004/10/07 08:09:14 janderse.umich.edu Exp $
*
***********************************************************************************
*
...
public interface SqlService
{
	...
	/*******************************************************************************
	* Operations on the default pool
	*******************************************************************************/
	...
	*******************************************************************************/
	...
	/**
	 * Create a new, named pool of connections.
	 * @param poolId The new pool id.  Must be unique.
	 * @return The new pool.
	 * @throws IdUsedException if the id is already in use.
	 */
	ConnectionPool newPool(String poolId) throws IdUsedException;

	/**
	 * Access an existing pool.
	 * @param poolId The new pool id.
	 * @return The pool.
	 * @throws IdUnusedException if the pool id does not identify a defined pool.
	 */
	ConnectionPool getPool(String poolId) throws IdUnusedException;

	/**
	 * Access all defined pools.
	 * @return A List of the pools.
	 */
	List getPools();

	/**
	 * Delete the identified pool.
	 * @param poolId The id of the pool to delete.
	 * @throws IdUnusedException if the pool id does not identify a defined pool.
	 */
	void deletePool(String poolId) throws IdUnusedException;

	/**
	 * Select which pool is the default pool
	 * @param poolId The id of the pool to be default.
	 * @throws IdUnusedException if the pool id does not identify a defined pool.
	 */
	void setDefaultPool(String poolId) throws IdUnusedException;
