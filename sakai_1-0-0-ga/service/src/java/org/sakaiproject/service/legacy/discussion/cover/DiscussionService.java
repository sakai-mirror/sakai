/**********************************************************************************
*
* $Header: /cvs/sakai/service/src/java/org/sakaiproject/service/legacy/discussion/cover/DiscussionService.java,v 1.14 2004/09/06 00:22:09 ggolden.umich.edu Exp $
*
***********************************************************************************
*
...
package org.sakaiproject.service.legacy.discussion.cover;

import org.sakaiproject.service.framework.component.cover.ComponentManager;

/**
* <p>DiscussionService is a static Cover for the {@link org.sakaiproject.service.legacy.discussion.DiscussionService DiscussionService};
...
public class DiscussionService
{
	 ...
	 */
	public static org.sakaiproject.service.legacy.discussion.DiscussionService getInstance()
	{
		if (ComponentManager.CACHE_SINGLETONS)
		{
			if (m_instance == null) m_instance = (org.sakaiproject.service.legacy.discussion.DiscussionService) ComponentManager.get(org.sakaiproject.service.legacy.discussion.DiscussionService.class);
			return m_instance;
		}
		else
		{
			return (org.sakaiproject.service.legacy.discussion.DiscussionService) ComponentManager.get(org.sakaiproject.service.legacy.discussion.DiscussionService.class);
		}
	}
	private static org.sakaiproject.service.legacy.discussion.DiscussionService m_instance = null;

	public static java.lang.String SERVICE_NAME = org.sakaiproject.service.legacy.discussion.DiscussionService.SERVICE_NAME;
	public static java.lang.String REFERENCE_ROOT = org.sakaiproject.service.legacy.discussion.DiscussionService.REFERENCE_ROOT;
	public static java.lang.String SECURE_ADD_TOPIC = org.sakaiproject.service.legacy.discussion.DiscussionService.SECURE_ADD_TOPIC;
	public static java.lang.String SECURE_READ = org.sakaiproject.service.legacy.discussion.DiscussionService.SECURE_READ;
	public static java.lang.String SECURE_ADD = org.sakaiproject.service.legacy.discussion.DiscussionService.SECURE_ADD;
	public static java.lang.String SECURE_REMOVE_OWN = org.sakaiproject.service.legacy.discussion.DiscussionService.SECURE_REMOVE_OWN;
	...
	public static org.sakaiproject.service.legacy.discussion.DiscussionChannelEdit addDiscussionChannel(java.lang.String param0) throws org.sakaiproject.exception.IdUsedException, org.sakaiproject.exception.IdInvalidException, org.sakaiproject.exception.PermissionException
	{
		org.sakaiproject.service.legacy.discussion.DiscussionService service = getInstance();
		if (service == null)
			return null;
