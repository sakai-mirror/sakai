/**********************************************************************************
*
* $Header: /cvs/sakai/service/src/java/org/sakaiproject/service/legacy/realm/cover/RealmService.java,v 1.8 2004/07/22 17:04:24 janderse.umich.edu Exp $
*
***********************************************************************************
*
...
public class RealmService
{
	...
	public static java.util.List getRealms()
	{
	...
	public static org.sakaiproject.service.legacy.realm.Realm getRealm(java.lang.String param0, java.lang.String param1)
	{
		org.sakaiproject.service.legacy.realm.RealmService service = getInstance();
		if (service == null)
			return null;

		return service.getRealm(param0, param1);
	}
	...
	public static void setPubView(java.lang.String param0, boolean param1) throws org.sakaiproject.exception.InUseException
	{
		org.sakaiproject.service.legacy.realm.RealmService service = getInstance();
		if (service == null)
			return;
	...
	public static boolean getPubView(java.lang.String param0)
	{
		org.sakaiproject.service.legacy.realm.RealmService service = getInstance();
		if (service == null)
			return false;

		return service.getPubView(param0);
	}

	public static boolean getPubViewInheritance(java.lang.String param0)
	{
		org.sakaiproject.service.legacy.realm.RealmService service = getInstance();
		if (service == null)
			return false;

		return service.getPubViewInheritance(param0);
	}
	...
	public static org.sakaiproject.service.legacy.realm.Abilities newAbilities()
	{
		org.sakaiproject.service.legacy.realm.RealmService service = getInstance();
		if (service == null)
			return null;

		return service.newAbilities();
	}
}
