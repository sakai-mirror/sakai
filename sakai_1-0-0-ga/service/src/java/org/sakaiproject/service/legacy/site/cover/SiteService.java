/**********************************************************************************
*
* $Header: /cvs/sakai/service/src/java/org/sakaiproject/service/legacy/site/cover/SiteService.java,v 1.15 2004/08/11 20:21:16 ggolden.umich.edu Exp $
*
***********************************************************************************
*
...
public class SiteService
{
	...
	public static java.util.List getAllowedSites(boolean param0, boolean param1, java.lang.Object param2)
	{
		org.sakaiproject.service.legacy.site.SiteService service = getInstance();
		if (service == null)
			return null;

		return service.getAllowedSites(param0, param1, param2);
	}
