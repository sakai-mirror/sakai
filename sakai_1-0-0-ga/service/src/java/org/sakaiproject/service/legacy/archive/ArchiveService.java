/**********************************************************************************
*
* $Header: /cvs/sakai/service/src/java/org/sakaiproject/service/legacy/archive/ArchiveService.java,v 1.6 2004/08/27 18:48:07 suiyy.umich.edu Exp $
*
***********************************************************************************
*
...
public interface ArchiveService
{
	...
	*/
	...
	/**
	* Read in an archived set of resources, and merge the entries into the specified site.
	...
	*/
	public String merge(String archiveUrl, String siteId);
