/**********************************************************************************
*
* $Header: /cvs/sakai/service/src/java/org/sakaiproject/service/legacy/archive/cover/ArchiveService.java,v 1.7 2004/07/22 17:04:24 janderse.umich.edu Exp $
*
***********************************************************************************
*
...
public class ArchiveService
{
	...
	public static java.lang.String merge(java.lang.String param0, java.lang.String param1)
	{
		org.sakaiproject.service.legacy.archive.ArchiveService service = getInstance();
		if (service == null)
			return null;

		return service.merge(param0, param1);
	}
