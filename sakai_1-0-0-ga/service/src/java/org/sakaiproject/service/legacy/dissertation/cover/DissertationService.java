/**********************************************************************************
*
* $Header: /cvs/sakai/service/src/java/org/sakaiproject/service/legacy/dissertation/cover/DissertationService.java,v 1.9 2004/09/15 23:28:43 rwellis.umich.edu Exp $
*
***********************************************************************************
*
...
public class DissertationService
{
	...
	public static boolean getIsMusicPerformanceCandidate(java.lang.String param0)
	{
		org.sakaiproject.service.legacy.dissertation.DissertationService service = getInstance();
		if (service == null)
			return false;

		return service.getIsMusicPerformanceCandidate(param0);
	}
	...
	public static boolean getIsCandidate(java.lang.String param0)
	{
		org.sakaiproject.service.legacy.dissertation.DissertationService service = getInstance();
		if (service == null)
			return false;

		return service.getIsCandidate(param0);
	}
