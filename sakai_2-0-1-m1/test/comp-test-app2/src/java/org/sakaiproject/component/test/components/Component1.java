/**********************************************************************************
 *
 * $Header: /cvs/sakai2/test/comp-test-app2/src/java/org/sakaiproject/component/test/components/Component1.java,v 1.3 2005/03/07 04:16:34 ggolden.umich.edu Exp $
 *
 ***********************************************************************************
 *
...
public class Component1 implements Api1
{
	...
	{
		return "I am the evil Component1/app2 posing as the Api1, nobody should have registered me, ha ha ha! "
				+ m_config;
	}
}
