...
<f:view>
<sakaix:view title="timerBar tag - Sakai 2.0 JSF example">
...
<h:form id="timerBarForm">
  <sakaix:timerBar height="15" width="300" wait="60" elapsed="30"
...
<FONT COLOR="#000000">  &lt;</FONT><FONT COLOR="#800080">h:outputText</FONT><FONT COLOR="#000000"> </FONT><FONT COLOR="#800000">value</FONT><FONT COLOR="#000000">=</FONT><FONT COLOR="#0000ff">"Timer bar test."</FONT><FONT COLOR="#000000">/&gt;
  &lt;</FONT><FONT COLOR="#800080">sakaix:timerBar</FONT><FONT COLOR="#000000"> </FONT><FONT COLOR="#800000">height</FONT><FONT COLOR="#000000">=</FONT><FONT COLOR="#0000ff">"15"</FONT><FONT COLOR="#000000"> </FONT><FONT COLOR="#800000">width</FONT><FONT COLOR="#000000">=</FONT><FONT COLOR="#0000ff">"300"</FONT><FONT COLOR="#000000"> </FONT><FONT COLOR="#800000">wait</FONT><FONT COLOR="#000000">=</FONT><FONT COLOR="#0000ff">"60"</FONT><FONT COLOR="#000000"> </FONT><FONT COLOR="#800000">elapsed</FONT><FONT COLOR="#000000">=</FONT><FONT COLOR="#0000ff">"30"</FONT><FONT COLOR="#000000">
