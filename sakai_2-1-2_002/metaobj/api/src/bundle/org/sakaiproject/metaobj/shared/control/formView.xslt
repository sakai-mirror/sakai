   ...
   <xsl:template name="produce-label">
	...
	<xsl:template name="produce-metadata">
		<tr>
			...
			<td><xsl:value-of select="/formView/formData/artifact/metaData/repositoryNode/created" /></td>
		</tr>
		<tr>
			<td>
				<label>Modified</label>
			</td>
			<td><xsl:value-of select="/formView/formData/artifact/metaData/repositoryNode/modified" /></td>
		</tr>
	</xsl:template>
