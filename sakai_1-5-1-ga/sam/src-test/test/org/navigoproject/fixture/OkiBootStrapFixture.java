 ...
 * @version $Id: OkiBootStrapFixture.java,v 1.1.1.1 2004/07/28 21:32:08 rgollub.stanford.edu Exp $
 */
public class OkiBootStrapFixture
{
  private static final org.apache.log4j.Logger LOG =
    org.apache.log4j.Logger.getLogger(OkiBootStrapFixture.class);

  /**
   * Creates a new OkiBootStrapFixture object.
   *
   * @param obj DOCUMENTATION PENDING
   *
   * @throws Error DOCUMENTATION PENDING
   */
  public OkiBootStrapFixture(Object obj)
  {
    try
    {
      PathInfo pathInfo = PathInfo.getInstance();
      MockHttpServletRequest request = new MockHttpServletRequest(null);
      OsidOwner owner = OsidManagerFactory.getOsidOwner();
