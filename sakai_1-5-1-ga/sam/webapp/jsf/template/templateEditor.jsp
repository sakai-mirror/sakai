...
<%@ taglib uri="http://www.sakaiproject.org/samigo" prefix="samigo" %>
  ...
  <f:loadBundle
    ...
    <html xmlns="http://www.w3.org/1999/xhtml">
      ...
      <body onload="javascript:hideUnhideAllDivsWithWysiwyg('none');">
<!-- content... -->
 ...
 <f:verbatim><h3></f:verbatim><h:outputText value="#{msg.template_editor}"/>
 ...
 <h:outputText value="#{msg.template_instructions}"/>
  ...
  <samigo:hideDivision id="div1" title="#{msg.template_inform}" >
    <f:verbatim><div class="indnt1"></f:verbatim>
    <h:panelGrid columns="3" columnClasses="shorttext"
      ...
      <h:outputLabel for="infocanbeviewed" value="#{msg.template_canbeviewed}"/>
      <h:outputText value=" "/>
  ...
  <samigo:hideDivision title="#{msg.introduction}" id="div2">
    <f:verbatim><div class="indnt1"></f:verbatim>
    <h:outputText value="#{msg.template_canbeedited}"/>
...
--%>
  ...
  <samigo:hideDivision title="#{msg.organization}" id="div7">
    ...
    <!-- NAVIGATION -->
     <h4 class="plain"><h:outputText style="h4"
       styleClass="plain,indnt2" value="#{msg.navigation}"/></h4>

     <h:panelGrid columns="2" styleClass="indnt2">
    ...
    <!-- QUESTION LAYOUT -->
     <f:verbatim><h4 class="plain"></f:verbatim><h:outputText
       value="#{msg.question_layout}"/><f:verbatim></h4></f:verbatim>

     <h:panelGrid columns="2" styleClass="indnt2"
      summary="#{msg.question_layout_sub}">
    ...
    <!-- NUMBERING -->
     <f:verbatim><h4 class="plain"></f:verbatim><h:outputText
       value="#{msg.numbering}"/><f:verbatim></h4></f:verbatim>

     <h:panelGrid columns="2" styleClass="indnt2"
      summary="#{msg.numbering_sub}">
  ...
  <samigo:hideDivision title="#{msg.submissions}" id="div8">
    ...
    <h:outputText style="h4" styleClass="indnt2,plain"
      value="#{msg.number_of_sub_allowed}"/></h4>
    ...
    <h:panelGroup>
     ...
     </h:selectOneRadio><h:inputText value="#{template.submissionNumber}"
       id="submissions_allowed" size="5"/> <h:outputLabel
       for="submissions_allowed" value="#{msg.submissions_allowed}"/>
    </h:panelGroup>
    </h:panelGrid>

    <!-- LATE HANDLING -->
    <h:outputText style="h4" styleClass="indnt2,plain"
      value="#{msg.late_handling}"/>
...
--%>
  ...
  <samigo:hideDivision title="#{msg.feedback}" id="div10">
    ...
    <!-- FEEDBACK DELIVERY -->
    <h:outputText style="h4" styleClass="plain,indnt2"
      value="#{msg.feedback_delivery}"/></h4>
    ...
    <!-- FEEDBACK COMPONENTS -->
    <h:outputText style="h4" styleClass="plain,indnt2"
      value="#{msg.select_feedback_comp}"/>
...
--%>
  ...
  <samigo:hideDivision title="#{msg.grading}" id="div11">
    ...
    <h:selectOneRadio layout="pageDirection" value="#{template.toGradebook}"
      ...
      <f:selectItem itemValue="2" itemLabel="#{msg.grades_to_selected}"/>
    </h:selectOneRadio>
      </h:panelGroup>
     </h:panelGrid>
    ...
    <h:outputText style="h4" styleClass="indnt2,plain"
      value="#{msg.record_score_if_multi}"/>
  ...
  <samigo:hideDivision title="#{msg.metadata}" id="div13">
    <f:verbatim><div class="indnt1"></f:verbatim>
    <h:outputText value="#{msg.record_data_for}"/>
    <h:panelGrid columns="2"
