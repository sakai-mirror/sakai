...
<!-- $Id: submitted.jsp,v 1.14.2.3 2005/03/28 16:46:24 daisyf.stanford.edu Exp $ -->
  <f:view>
...
<div class="tier2">
  ...
  <h:panelGrid columns="2">
    ...
    <h:outputText value="#{msg.course_name}" rendered="#{!delivery.accessViaUrl}"/>
    <h:outputText value="#{delivery.courseName}" rendered="#{!delivery.accessViaUrl}"/>

    <h:outputText value="#{msg.instructor}" rendered="#{!delivery.accessViaUrl}"/>
    <h:outputText value="#{delivery.instructorName}" rendered="#{!delivery.accessViaUrl}"/>
