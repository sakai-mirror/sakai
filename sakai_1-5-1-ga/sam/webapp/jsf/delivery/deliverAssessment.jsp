...
<!-- $Id: deliverAssessment.jsp,v 1.32.2.4 2005/03/20 22:48:35 daisyf.stanford.edu Exp $ -->
  <f:view>
...
<h:panelGrid columns="3" cellpadding="3" cellspacing="3" >
  ...
  <h:commandButton type="submit" value="#{msg.button_submit_grading}"
    ...
    rendered="#{delivery.accessViaUrl || (delivery.previewMode ne 'true' && delivery.navigation eq '1')}" 
    onclick="pauseTiming='true'">
  </h:commandButton>

  <h:commandButton type="submit" value="#{msg.button_save_x}" 
    action="#{delivery.saveAndExit}" id="saveAndExit"
    rendered="#{delivery.previewMode ne 'true' && !delivery.accessViaUrl}" onclick="pauseTiming='true'">
  </h:commandButton>
