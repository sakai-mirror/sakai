...
<!-- $Id: previewAssessment.jsp,v 1.4 2005/02/15 22:13:20 zqingru.stanford.edu Exp $ -->
...
<h:dataTable border="1" styleClass="listHier" id="parts" width="100%" headerClass="regHeading"
 ...
 <h:commandButton value="#{msg.button_back}"  action="editAssessment" type="submit"/>
