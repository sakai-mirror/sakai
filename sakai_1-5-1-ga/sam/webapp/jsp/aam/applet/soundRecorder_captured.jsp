...
//--></script>
<html:form action="htmlInlineAnswer.do" method="post" onsubmit="javascript:onOK();"
  ...
  <!--the following are the combination keys of the response field in parent window-->
