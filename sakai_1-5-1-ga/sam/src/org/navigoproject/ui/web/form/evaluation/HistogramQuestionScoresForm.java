 ...
 * @version 1.0
 */
public class HistogramQuestionScoresForm
  extends ActionForm
// implements Serializable
{
  ...
  static Logger logger =
    Logger.getLogger(HistogramQuestionScoresForm.class.getName());

  /**
   * Creates a new HistogramQuestionScoresForm object.
   */
  public HistogramQuestionScoresForm()
  {
    super();
   ...
   * DOCUMENTATION PENDING
   *
   * @param pquestionText DOCUMENTATION PENDING
   */
   ...
   * DOCUMENTATION PENDING
   *
   * @param pcorrectAnswer DOCUMENTATION PENDING
   */
   ...
   * DOCUMENTATION PENDING
   *
   * @param pquestionType DOCUMENTATION PENDING
   */
   ...
   * DOCUMENTATION PENDING
   *
   * @param ppercentCorrect DOCUMENTATION PENDING
   */
 ...
 /**
   ...
   * DOCUMENTATION PENDING
   *
   * @param ptotalResponses DOCUMENTATION PENDING
   */
