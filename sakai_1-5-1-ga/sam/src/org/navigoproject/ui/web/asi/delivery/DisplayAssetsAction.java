 ...
 *
 * @author $author$
 * @version $Id: DisplayAssetsAction.java,v 1.1.1.1 2004/07/28 21:32:07 rgollub.stanford.edu Exp $
 */
public class DisplayAssetsAction
  extends Action
{
  /**
   * DOCUMENTATION PENDING
   ...
   * @throws AuthenticationException DOCUMENTATION PENDING
   */
  public ActionForward execute(
    ActionMapping mapping, ActionForm actionForm, HttpServletRequest request,
    HttpServletResponse response)
    throws SharedException, AuthenticationException
  {
    String username =
      org.navigoproject.osid.OsidManagerFactory.getAgent().getId()
                                               .getIdString();
    ArrayList assets = (new XmlDeliveryService()).getAssets(username);
    DisplayAssetsForm form = (DisplayAssetsForm) actionForm;
