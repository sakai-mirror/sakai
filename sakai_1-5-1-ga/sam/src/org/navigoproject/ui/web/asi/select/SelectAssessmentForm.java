 ...
 * @version $Id: SelectAssessmentForm.java,v 1.1.1.1 2004/07/28 21:32:07 rgollub.stanford.edu Exp $
 */
public class SelectAssessmentForm
  extends ActionForm
{
  private ArrayList takeableAssessments;
  private ArrayList lateHandlingAssessments;
  
  private ArrayList reviewAssessments;
   ...
   */
  public ArrayList getReviewAssessments()
  {
    return reviewAssessments;
  }

  /**
   * DOCUMENTATION PENDING
   *
   * @param reviewAssessments DOCUMENTATION PENDING
   */
  public void setReviewAssessments(ArrayList reviewAssessments)
  {
    this.reviewAssessments = reviewAssessments;
  }
  
  public ArrayList getNonRevialbleAssessments()
  {
