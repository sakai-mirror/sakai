 ...
 */
package org.navigoproject.ui.web.asi.exporting;
 ...
 *         Comments
 */
public class ExportAssessmentAction
  extends Action
{
  private static org.apache.log4j.Logger LOG =
    org.apache.log4j.Logger.getLogger(ExportAssessmentAction.class);
    ...
    throws Exception
  {
    ...
    Id id = manager.getId(assessmentId);
    Asset asset = manager.getAsset(id);
   
    String data = (String) asset.getContent();
    RealizationManager realization = new RealizationManager();
    String xmlString = realization.compose(data);
    response.setContentType("text/plain");
    response.setHeader("Content-disposition","attachment; filename="+asset.getDisplayName()+".xml");
