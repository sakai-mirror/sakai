 ...
 * @version 1.0
 */
public class AssessmentTemplateIteratorImpl
  implements AssessmentTemplateIterator
{
  private Iterator templates;

  /**
   * Creates a new AssessmentTemplateIteratorImpl object.
   *
   * @param ptemplates DOCUMENTATION PENDING
   */
  public AssessmentTemplateIteratorImpl(Collection ptemplates)
  {
    templates = ptemplates.iterator();
  }
   ...
   */
  public AssessmentTemplate next()
    throws AssessmentException
  {
    try
    {
      return (AssessmentTemplate) templates.next();
    }
    catch(Exception e)
    {
