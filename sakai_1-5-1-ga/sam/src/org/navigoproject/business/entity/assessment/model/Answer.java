...
/**
 * This holds an answer.  Since answers haven't really been defined yet, this
 * will be a simplest case object.  more to do later.
 *
...
public class Answer
{
   ...
   */
  public Answer(Id pid)
  {
    id = new Integer(pid.toString()).intValue();
  }
   ...
   * DOCUMENTATION PENDING
   *
   * @param pcorrect DOCUMENTATION PENDING
   */
   ...
   */
  public void setMediaData(MediaData md)
  {
    data = md;
  }
}
