 ...
 *
 * @author $author$
 * @version $Id: SectionTemplatePropertiesImpl.java,v 1.1.1.1 2004/07/28 21:32:06 rgollub.stanford.edu Exp $
 */
public class SectionTemplatePropertiesImpl
  extends SectionPropertiesImpl
  implements SectionTemplateProperties
{
  ...
  /**
   * Creates a new SectionTemplatePropertiesImpl object.
   */
  public SectionTemplatePropertiesImpl()
  {
  ...
  public boolean isStudentViewable(String field)
  {
    ...
    if((viewable == null) || viewable.booleanValue())
    {
      return true;
    }
