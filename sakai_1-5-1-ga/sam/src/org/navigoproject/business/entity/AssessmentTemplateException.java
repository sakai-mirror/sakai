 ...
 * @version 1.0
 */
public class AssessmentTemplateException
  extends AssessmentException
{
  /**
   * Creates a new AssessmentTemplateException object.
   *
   * @param message DOCUMENTATION PENDING
   *
   * @throws osid.assessment.AssessmentException DOCUMENTATION PENDING
   */
  public AssessmentTemplateException(String message)
