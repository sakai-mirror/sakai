 ...
 * <p>Company: </p>
 * @author jlannan
 * @version $Id: PersistenceService.java,v 1.7 2005/02/14 18:18:10 daisyf.stanford.edu Exp $
 */
...
public class PersistenceService{
	...
	public void setAssessmentGradingFacadeQueries(AssessmentGradingFacadeQueries assessmentGradingFacadeQueries){		
	  ...
	  this.pagingUtilQueries = pagingUtilQueries;
        ...
        public AuthzQueriesFacade getAuthzQueriesFacade(){
	  return authzQueriesFacade;
        }

        public void setAuthzQueriesFacade(AuthzQueriesFacade authzQueriesFacade){
