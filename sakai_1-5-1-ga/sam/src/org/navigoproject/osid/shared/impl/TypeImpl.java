 ...
 * @version $Id: TypeImpl.java,v 1.2 2004/09/29 02:04:36 daisyf.stanford.edu Exp $
 */
public class TypeImpl
  extends osid.shared.Type
{
  private static final org.apache.log4j.Logger LOG =
    org.apache.log4j.Logger.getLogger(TypeImpl.class);
   ...
   */
  public TypeImpl(String domain, String authority, String keyword)
  {
  ...
  {
    return "{domain=" + this.getDomain() + ", authority=" +
    this.getAuthority() + ", keyword=" + this.getKeyword() + ", description=" +
    this.getDescription() + "}";
  }
  ...
  public boolean equals(Object o)
  {
    ...
    try
    {
      return this.isEqual((osid.shared.Type) o);
    }
    catch(Exception ex)
    {
  ...
  {
    LOG.debug("hashCode()");
    String pk = this.getDomain() + this.getAuthority() + this.getKeyword();
