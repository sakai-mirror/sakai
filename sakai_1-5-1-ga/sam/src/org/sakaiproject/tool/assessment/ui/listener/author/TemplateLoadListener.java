 ...
 * @author Ed Smiley
 * @version $Id: TemplateLoadListener.java,v 1.4 2005/02/15 00:08:40 daisyf.stanford.edu Exp $
 */
...
{
  static Logger LOG = Logger.getLogger(TemplateLoadListener.class.getName());
