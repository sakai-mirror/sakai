 ...
 * @author Ed Smiley
 * @version $Id: QuestionScoreUpdateListener.java,v 1.10 2005/02/11 07:18:05 rgollub.stanford.edu Exp $
 */

public class QuestionScoreUpdateListener
  implements ActionListener
{
  static Logger LOG = Logger.getLogger(QuestionScoreUpdateListener.class.
                      getName());
