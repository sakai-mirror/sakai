 ...
 * @version $Id: ReorderPartsListener.java,v 1.2.2.1 2005/03/09 16:54:30 daisyf.stanford.edu Exp $
 */

public class ReorderPartsListener
    implements ValueChangeListener
{
 static Logger LOG = Logger.getLogger(ReorderPartsListener.class.getName());
