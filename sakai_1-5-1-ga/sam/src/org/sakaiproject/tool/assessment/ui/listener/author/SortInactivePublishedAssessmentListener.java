 ...
 * @author Ed Smiley
 * @version $Id: SortInactivePublishedAssessmentListener.java,v 1.6.2.1 2005/04/04 19:42:22 daisyf.stanford.edu Exp $
 */
    ...
    implements ActionListener
{
  ...
  public void processAction(ActionEvent ae) throws AbortProcessingException
  {
    ...
    String sortString = (String) FacesContext.getCurrentInstance().
        getExternalContext().getRequestParameterMap().get("inactiveOrderBy");
    author.setInactivePublishedAssessmentOrderBy(sortString);

    ArrayList inactivePublishedList = new ArrayList();
    inactivePublishedList = publishedAssessmentService.
          getBasicInfoOfAllInActivePublishedAssessments(sortString);
