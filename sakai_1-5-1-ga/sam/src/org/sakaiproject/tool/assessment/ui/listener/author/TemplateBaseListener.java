 ...
 * @version $Id: TemplateBaseListener.java,v 1.5 2004/11/18 06:19:21 rgollub.stanford.edu Exp $
 */
...
public abstract class TemplateBaseListener implements ActionListener
{
  ...
  static Logger LOG = Logger.getLogger(TemplateBaseListener.class.getName());
