 ...
 * @author Ed Smiley
 * @version $Id: EvaluationListenerUtil.java,v 1.4.4.1 2005/04/04 19:42:23 daisyf.stanford.edu Exp $
 */

public class EvaluationListenerUtil
{
  static Logger LOG = Logger.getLogger(EvaluationListenerUtil.class.getName());
