 ...
 * @version $Id: StudentScoreUpdateListener.java,v 1.2.2.1 2005/04/04 19:42:22 daisyf.stanford.edu Exp $
 */

public class StudentScoreUpdateListener
  implements ActionListener
{
  static Logger LOG = Logger.getLogger(StudentScoreUpdateListener.class.
                      getName());
