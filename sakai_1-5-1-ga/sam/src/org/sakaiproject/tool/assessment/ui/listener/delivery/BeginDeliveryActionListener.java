 ...
 * @author Ed Smiley
 * @version $Id: BeginDeliveryActionListener.java,v 1.36.2.5 2005/03/23 02:56:11 daisyf.stanford.edu Exp $
 */

public class BeginDeliveryActionListener implements ActionListener
{
  static Logger LOG = Logger.getLogger(BeginDeliveryActionListener.class.
                      getName());
