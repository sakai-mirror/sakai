 ...
 * @author Ed Smiley
 * @version $Id: TotalScoreListener.java,v 1.31.2.1 2005/04/04 19:42:22 daisyf.stanford.edu Exp $
 */

public class TotalScoreListener
  implements ActionListener, ValueChangeListener
{
  static Logger LOG = Logger.getLogger(TotalScoreListener.class.getName());
