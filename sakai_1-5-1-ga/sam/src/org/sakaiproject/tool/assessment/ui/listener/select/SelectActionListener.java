 ...
 * @author Ed Smiley
 * @version $Id: SelectActionListener.java,v 1.37.2.13 2005/04/04 19:42:23 daisyf.stanford.edu Exp $
 */
  ...
  private ArrayList getTakeableList(ArrayList assessmentList, HashMap h) {
    ...
    for (int i = 0; i < assessmentList.size(); i++) {
      ...
      if (PersistenceService.getInstance().getAuthzQueriesFacade().isAuthorized(
           AgentFacade.getAgentString(), "TAKE_ASSESSMENT",
