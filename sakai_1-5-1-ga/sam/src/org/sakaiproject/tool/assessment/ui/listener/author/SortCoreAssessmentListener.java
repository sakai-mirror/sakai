 ...
 * @author Ed Smiley
 * @version $Id: SortCoreAssessmentListener.java,v 1.2.2.1 2005/04/04 19:42:22 daisyf.stanford.edu Exp $
 */
    ...
    implements ActionListener
{
  ...
  public void processAction(ActionEvent ae) throws AbortProcessingException
  {
    ...
    if ((orderBy).equals(AssessmentFacadeQueries.LASTMODIFIEDDATE))
      assessmentList = assessmentService.getBasicInfoOfAllActiveAssessments(
        AssessmentFacadeQueries.LASTMODIFIEDDATE);
    else
      assessmentList = assessmentService.getBasicInfoOfAllActiveAssessments(
