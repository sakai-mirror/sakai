 ...
 * @version $Id: RichTextEditArea.java,v 1.3 2004/12/13 19:19:02 esmiley.stanford.edu Exp $
 */
public class RichTextEditArea extends Renderer
{
  ...
  {
    return (component instanceof org.sakaiproject.jsf.component.RichTextEditArea);
  }
      ...
      throws IOException
  {
    ...
    if ((justArea != null) && (justArea.equals("yes")))
    {
      ...
      if ((tmpCol != null) && (tmpRow != null))
      {
        ...
        writer.write(clientId);
        writer.write("_textinput\',config);</script>\n");
      }
      else
        if (tmpCol != null)
        {
        ...
        {
          writer.write("<script type=\"text/javascript\">var config=new HTMLArea.Config();");
          writer.write("config.toolbar=[];config.width=\'400px\';config.height=\'100px\';");
          writer.write("HTMLArea.replace(\'");
          writer.write(clientId);
          writer.write("_textinput\',config);</script>\n");
        }
    ...
    else
    {
      if (value == null)
      {
        ...
        {
          /*
           * writer.write(" <textarea name=\"" + clientId + "_textinput\" id=\"" + clientId +
           * "_textinput\"" + " cols=\"" + outCol + "\" rows=\"" + outRow + "\" onclick=\"var config=new
           * HTMLArea.Config();" + "config.toolbar = [[\'fontname\', \'space\',\'fontsize\',
           * \'space\',\'formatblock\', \'space\',\'bold\', \'italic\', \'underline\']," +
           * "[\'separator\',\'strikethrough\', \'subscript\', \'superscript\', \'separator\', \'copy\',
           * \'cut\', \'paste\', \'space\', \'undo\', \'redo\', \'separator\', \'justifyleft\',
           * \'justifycenter\', \'justifyright\', \'justifyfull\', \'separator\',\'outdent\',
           * \'indent\']," + "[\'separator\',\'forecolor\', \'hilitecolor\', \'textindicator\',
           * \'separator\',\'inserthorizontalrule\', \'createlink\', \'insertimage\', \'inserttable\',
           * \'htmlmode\', \'separator\',\'popupeditor\', \'separator\', \'showhelp\', \'about\' ],"+
           * "];" + "HTMLArea.replace(\'" + clientId +"_textinput\',config);" + "\">" + "
           * </textarea>\n");
           */
          writer.write("<script type=\"text/javascript\"> var config=new HTMLArea.Config();");
        ...
        else
        {
           ...
           * "_textinput\"" + " cols=\"" + outCol + "\" rows=\"" + outRow + "\" onclick=\"var config=new
           * HTMLArea.Config();" + "config.toolbar = [[\'fontname\', \'space\',\'fontsize\',
           * \'space\',\'formatblock\', \'space\',\'bold\', \'italic\',
           ...
           * \'separator\',\'outdent\', \'indent\',\'separator\',\'forecolor\', \'hilitecolor\',
           * \'textindicator\', \'separator\',\'inserthorizontalrule\', \'createlink\', \'insertimage\',
           * \'inserttable\', \'htmlmode\', \'separator\',\'popupeditor\', \'separator\', \'showhelp\',
           * \'about\' ],"+ "];" + "HTMLArea.replace(\'" + clientId +"_textinput\',config);" + "\">" + "
           * </textarea>\n");
           */
          writer.write("<script type=\"text/javascript\">var config=new HTMLArea.Config();");
      ...
      else
      {
        ...
        if (lineOfToolBar ==3)
        {
           ...
           * \'separator\',\'inserthorizontalrule\', \'createlink\', \'insertimage\', \'inserttable\',
           * \'htmlmode\', \'separator\',\'popupeditor\', \'separator\', \'showhelp\', \'about\' ],"+
           * "];" + "HTMLArea.replace(\'" + clientId +"_textinput\',config);" + "\">" + value + "
           * </textarea>\n");
           */
          writer.write("<script type=\"text/javascript\"> var config=new HTMLArea.Config();");
          writer.write("config.toolbar = [[\'fontname\', \'space\',\'fontsize\', \'space\',\'formatblock\', \'space\',\'bold\', \'italic\', \'underline\'],");
