 ...
 * @version $Id: QTITester.java,v 1.5 2005/01/13 23:56:10 esmiley.stanford.edu Exp $
 */
...
//    testAuthoringXmlTemplates();
  ...
  private static void testAuthoringHelper()
  {
    ...
    ArrayList list = pService.getAllActivePublishedAssessments(1,1,"title");
    ...
    for (int i = 0; i < list.size(); i++)
    {
      ...
      Document doc = authHelper.getPublishedAssessment(pubid, is);
