/**********************************************************************************
*
* $Header: /cvs/sakai/provider/src/java/org/sakaiproject/component/legacy/user/SampleUserDirectoryProvider.java,v 1.9 2004/11/19 20:48:42 ggolden.umich.edu Exp $
*
***********************************************************************************
*
	...
	implements UserDirectoryProvider
{
	...
	*/
	public SampleUserDirectoryProvider()
	{
		...
		m_info.put("user1", new Info("user", "One","User", "user1@sakaiproject.org"));
