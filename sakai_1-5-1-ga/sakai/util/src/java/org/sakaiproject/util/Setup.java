/**********************************************************************************
*
* $Header: /cvs/sakai/util/src/java/org/sakaiproject/util/Setup.java,v 1.9.2.3 2005/03/21 15:19:09 lance.indiana.edu Exp $
*
***********************************************************************************
@license@
**********************************************************************************/
...
public class Setup
{
	...
	{
		return doSetup(req, resp, null, true);
	}
	...
	{
		return doSetup(req, resp, null, false);
	}
	...
	{
		return doSetup(req, resp, userId, false);
	}	
	 ...
	 * the servlet should not continue further and false if processing can continue normally.
	 */
	protected static boolean doSetup(HttpServletRequest req, HttpServletResponse resp, String userId, boolean full) throws Exception
	{
