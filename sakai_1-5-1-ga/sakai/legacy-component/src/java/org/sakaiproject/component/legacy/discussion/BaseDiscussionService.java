/**********************************************************************************
*
* $Header: /cvs/sakai/legacy-component/src/java/org/sakaiproject/component/legacy/discussion/BaseDiscussionService.java,v 1.22.2.4 2005/04/06 06:05:23 lance.indiana.edu Exp $
*
***********************************************************************************
*
		...
		*/
			...
			throws PermissionException
		{
				...
				&&	(m_categories.contains(category)))
			{
				...
				//track event (no notification)
				Event event = EventTrackingService.newEvent(eventId(((BaseDiscussionChannelEdit) this).getEvent()), this.getReference(), true, NotificationService.NOTI_NONE);
				EventTrackingService.post(event);
				//channel notification
				notify(event);
