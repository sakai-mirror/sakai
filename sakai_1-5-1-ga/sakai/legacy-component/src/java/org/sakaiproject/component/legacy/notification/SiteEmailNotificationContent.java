/**********************************************************************************
*
* $Header: /cvs/sakai/legacy-component/src/java/org/sakaiproject/component/legacy/notification/SiteEmailNotificationContent.java,v 1.8.4.2 2005/03/21 15:19:11 lance.indiana.edu Exp $
*
***********************************************************************************
*
...
public class SiteEmailNotificationContent extends SiteEmailNotification
{
	...
	*/
	public String getSubject(Event event)
	{
		...
		return "["
			+ title
			+ " - "
			+ (ContentHostingService.EVENT_RESOURCE_ADD.equals(function) ? "New" : "Changed")
			+ " Resource] "
			+ resourceName;
	} // getSubject
	...
	*/
	protected String getMessage(Event event)
	{
		...
		{
			buf.append("A new resource has been added to");
		}
		else
		{
			buf.append("A resource has been updated in");
		}
		buf.append(
			" the "
				+ title
		...
		buf.append("\nLocation: site " + title + " > Resources" + path + " > " + resourceName);
		if (copyrightAlert)
		{
			buf.append("©");
		}
