/**********************************************************************************
*
* $Header: /cvs/sakai/legacy-component/src/java/org/sakaiproject/component/legacy/notification/EmailNotification.java,v 1.21 2005/02/10 23:24:07 janderse.umich.edu Exp $
*
***********************************************************************************
*
	...
	public void notify(Notification notification, Event event)
	{
		...
		if (immediate.size() > 0)
		{
			...
			String messageForImmediates = message
						...
						+ " from the " 
						+ title						+ " site.  " + newline
						+ "You can modify how you receive notifications at MyWorkspace > Preferences." + newline;
