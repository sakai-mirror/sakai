/**********************************************************************************
*
* $Header: /cvs/sakai/legacy-component/src/java/org/sakaiproject/component/legacy/notification/SiteEmailNotificationAnnc.java,v 1.10 2005/02/11 15:21:18 zqian.umich.edu Exp $
*
***********************************************************************************
*
	...
	extends SiteEmailNotification
{
	...
	*/
	protected String getMessage(Event event)
	{
		...
		{
			buf.append(newline + "Attachments:" + newline);
