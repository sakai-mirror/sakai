/**********************************************************************************
*
* $Header: /cvs/sakai/legacy-component/src/java/org/sakaiproject/component/legacy/message/BaseMessageService.java,v 1.47.2.1 2005/04/06 06:05:24 lance.indiana.edu Exp $
*
***********************************************************************************
*
	...
	public class BaseMessageChannelEdit extends Observable implements MessageChannelEdit, SessionStateBindingListener
	{
		...
		*/
		public void removeMessage(MessageEdit message) throws PermissionException
		{
			...
			try
			{
				RealmService.removeRealm(message.getReference());
			}
			catch (PermissionException e)
			{
