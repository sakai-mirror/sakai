/**********************************************************************************
*
* $Header: /cvs/sakai/legacy-component/src/java/org/sakaiproject/component/legacy/discussion/XmlFileDiscussionService.java,v 1.10 2004/11/08 03:50:27 ggolden.umich.edu Exp $
*
***********************************************************************************
*
...
/**
* <p>XmlFileDiscussionService fills out the BaseDiscussionService with a in-memory xml file backed up
...
*/
public class XmlFileDiscussionService
	extends BaseDiscussionService
{
	/** A full path and file name to the storage file. */
	protected String m_storagePath = "db/discussion.xml";
	...
	*******************************************************************************/
		...
		implements Storage
	{
		...
		*/
		...
		{
			super(m_storagePath, "discussion", "channel", "message", user);
