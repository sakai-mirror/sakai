/**********************************************************************************
*
* $Header: /cvs/sakai/legacy-component/src/java/org/sakaiproject/component/legacy/content/BaseContentService.java,v 1.40 2005/01/24 19:21:32 suiyy.umich.edu Exp $
*
***********************************************************************************
*
	...
	*******************************************************************************/
	...
	public void init()
	{
		try
		{
			...
			String value = m_serverConfigurationService.getString("content.filesystem.volumes", null);
			if (value != null)
			{
				m_bodyVolumes = StringUtil.split(value,",");
			}
