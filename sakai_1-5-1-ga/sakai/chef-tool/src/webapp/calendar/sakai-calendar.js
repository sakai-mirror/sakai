/**********************************************************************************
*
* $Header: /cvs/sakai/chef-tool/src/webapp/calendar/sakai-calendar.js,v 1.3 2004/07/06 17:35:58 janderse.umich.edu Exp $
*
***********************************************************************************
@license@
**********************************************************************************/
...
if (document.calendarcounter == undefined) 
{
	...
	document.write('<script type="text/javascript" src="/sakai-chef-tool/calendar/js/calendar2.js"></script>');
}
...
{		
	...
	document.write('<img src="/sakai-chef-tool/calendar/images/calendar/cal.gif" onClick="popupCalendar(\''+inputfield_id+'\');" alt="" style="cursor: pointer;" title="Popup date selector" />');
...
function popupCalendar(inputfield_id)
{
	...
	calObj.popup(null, "/sakai-chef-tool/calendar/html/");
}
