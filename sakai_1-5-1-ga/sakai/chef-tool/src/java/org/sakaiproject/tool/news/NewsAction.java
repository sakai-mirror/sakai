/**********************************************************************************
*
* $Header: /cvs/sakai/chef-tool/src/java/org/sakaiproject/tool/news/NewsAction.java,v 1.11 2005/02/11 21:21:59 janderse.umich.edu Exp $
*
***********************************************************************************
*
	...
	*/
	public void doUpdate(RunData data, Context context)
	{
		...
		if (newChannelUrl == null && currentChannelUrl  == null)
		{
			...
			addAlert(state, "Please provide a complete URL for the news feed.");
			return;
