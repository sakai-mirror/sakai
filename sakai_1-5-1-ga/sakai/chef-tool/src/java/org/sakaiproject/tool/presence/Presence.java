/**********************************************************************************
*
* $Header: /cvs/sakai/chef-tool/src/java/org/sakaiproject/tool/presence/Presence.java,v 1.11 2004/11/15 16:46:03 ajpoland.iupui.edu Exp $
*
***********************************************************************************
*
...
* @version $Id: Presence.java,v 1.11 2004/11/15 16:46:03 ajpoland.iupui.edu Exp $
*/
public class Presence extends VmServlet
{
	...
	private static final String ATTR_SHOW_PRESENCE = "showPresence";
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException
	{
		...
		// option to hide display of users present
		boolean showPresence = ServerConfigurationService.getBoolean("display.users.present", true);
		
		if (showPresence)
		setVmReference(ATTR_SHOW_PRESENCE, Boolean.valueOf(showPresence), req);
