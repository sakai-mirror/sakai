/**********************************************************************************
*
* $Header: /cvs/sakai/chef-tool/src/java/org/sakaiproject/tool/recent/SynopticMessageAction.java,v 1.24 2005/02/11 21:22:00 janderse.umich.edu Exp $
*
***********************************************************************************
*
...
//			}
	...
	*/
										...
										SessionState state)
	{
		...
		try
		{
			ToolConfiguration tool = (ToolConfiguration) rundata.getRequest().getAttribute(ATTR_TOOL);
			...
			if ((tool.getToolId()).equals("chef.synoptic.chat"))
			{
				...
				String defaultChannel = ChatService.channelReference(tool.getSiteId(), SiteService.MAIN_CONTAINER);
				String sitePrefix = defaultChannel.substring(0, defaultChannel.lastIndexOf(SiteService.MAIN_CONTAINER));
				String currentChannel = ((String) state.getAttribute(STATE_CHANNEL_REF)).substring(sitePrefix.length());				
