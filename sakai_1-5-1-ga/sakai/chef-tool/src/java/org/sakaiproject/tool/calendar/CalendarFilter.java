/**********************************************************************************
*
* $Header: /cvs/sakai/chef-tool/src/java/org/sakaiproject/tool/calendar/CalendarFilter.java,v 1.5 2005/02/11 21:21:58 janderse.umich.edu Exp $
*
***********************************************************************************
*
...
class CalendarFilter
{
		...
		StringBuffer errorMessage)
	{
		...
		{
			errorMessage.append("Invalid start or end date");
			return false;
		}
		...
		{
			errorMessage.append("The start date must be before the end date");
			return false;
		}
