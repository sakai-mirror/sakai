/**********************************************************************************
*
* $Header: /cvs/sakai/chef-tool/src/java/org/sakaiproject/tool/assignment/AssignmentAction.java,v 1.42.2.1 2005/03/21 18:44:34 lance.indiana.edu Exp $
*
***********************************************************************************
*
			...
			if (state.getAttribute(STATE_MESSAGE) == null)
			{
				...
				if (assignmentId.length ()==0)
				{
					...
					try
					{
						...
						a.getPropertiesEdit ().addProperty("newAssignment", Boolean.TRUE.toString());
					}
					catch (PermissionException e)
					{
				...
				else
				{
					...
					try
					{
						...
						{
							a.getPropertiesEdit ().removeProperty("newAssignment");
						}
					}
					catch (InUseException e )
					{
