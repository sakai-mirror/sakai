/**********************************************************************************
*
* $Header: /cvs/sakai/chef-tool/src/java/org/sakaiproject/tool/content/ResourcesAction.java,v 1.38.2.3 2005/04/06 06:05:25 lance.indiana.edu Exp $
*
***********************************************************************************
*
	...
	*/
											...
											SessionState state)
	{
		...
		if (StringUtil.trimToNull(data.getParameters().getString("special")) != null)
		{
			...
			{
				addAlert(state,"The upload size limit of " + FILE_UPLOAD_MAX_SIZE + "MB has been exceeded.  Please try uploading one file at a time.");
			}
			else
			{
				addAlert(state,"The upload size limit of " + FILE_UPLOAD_MAX_SIZE + "MB has been exceeded.");
			}
		}
		...
		context.put("maxUploadSize", ServerConfigurationService.getString("content.upload.max", "1"));
