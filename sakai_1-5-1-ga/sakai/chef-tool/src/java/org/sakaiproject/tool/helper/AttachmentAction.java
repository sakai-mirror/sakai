/**********************************************************************************
*
* $Header: /cvs/sakai/chef-tool/src/java/org/sakaiproject/tool/helper/AttachmentAction.java,v 1.16.4.3 2005/03/21 15:19:11 lance.indiana.edu Exp $
*
***********************************************************************************
*
...
public class AttachmentAction
{
	...
	private static final int FILE_UPLOAD_MAX_SIZE = 1;
	...
	*/
										...
										SessionState state)
	{
		...
		{
		    int maxSize = ServerConfigurationService.getInt("content.upload.max", FILE_UPLOAD_MAX_SIZE);
			VelocityPortletPaneledAction.addAlert(state,"The upload size limit of " + maxSize + "MB has been exceeded.");
		}
