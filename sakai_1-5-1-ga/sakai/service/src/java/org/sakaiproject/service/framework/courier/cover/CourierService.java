/**********************************************************************************
*
* $Header: /cvs/sakai/service/src/java/org/sakaiproject/service/framework/courier/cover/CourierService.java,v 1.6 2004/07/22 17:04:22 janderse.umich.edu Exp $
*
***********************************************************************************
*
...
public class CourierService
{
	...
	public static void deliver(java.lang.String param0, java.lang.String param1)
	{
		org.sakaiproject.service.framework.courier.CourierService service = getInstance();
		if (service == null)
			return;

		service.deliver(param0, param1);
	}
