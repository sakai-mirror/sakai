/**********************************************************************************
*
* $Header: /cvs/sakai/service/src/java/org/sakaiproject/service/framework/config/cover/ServerConfigurationService.java,v 1.15 2005/02/03 21:51:21 zqian.umich.edu Exp $
*
***********************************************************************************
*
...
public class ServerConfigurationService
{
	...
	public static java.lang.String getPortalTunnelUrl()
	{
		org.sakaiproject.service.framework.config.ServerConfigurationService service = getInstance();
		if (service == null)
			return null;

		return service.getPortalTunnelUrl();
	}
	...
	public static java.util.List getToolRegistrations()
	{
		org.sakaiproject.service.framework.config.ServerConfigurationService service = getInstance();
		if (service == null)
			return null;

		return service.getToolRegistrations();
	}
	
	public static java.util.List getToolRegistrations(java.lang.String param0)
	{
		org.sakaiproject.service.framework.config.ServerConfigurationService service = getInstance();
		if (service == null)
			return null;

		return service.getToolRegistrations(param0);
	}
	
	public static java.util.List getDefaultToolIds(java.lang.String param0)
	{
		org.sakaiproject.service.framework.config.ServerConfigurationService service = getInstance();
		if (service == null)
			return null;

		return service.getDefaultToolIds(param0);
	}

	public static org.sakaiproject.service.framework.config.ToolRegistration getToolRegistration(java.lang.String param0)
	{
		org.sakaiproject.service.framework.config.ServerConfigurationService service = getInstance();
		if (service == null)
			return null;

		return service.getToolRegistration(param0);
	}
