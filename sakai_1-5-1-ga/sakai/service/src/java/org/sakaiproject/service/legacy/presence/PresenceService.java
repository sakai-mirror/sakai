/**********************************************************************************
*
* $Header: /cvs/sakai/service/src/java/org/sakaiproject/service/legacy/presence/PresenceService.java,v 1.8 2004/09/30 20:20:51 ggolden.umich.edu Exp $
*
***********************************************************************************
*
...
public interface PresenceService
{
	...
	/**
	 * Parse the location into three strings: site, page, tool- possibly null.
	 * @return the parsed site, page and tool strings from the location id.
	 */
