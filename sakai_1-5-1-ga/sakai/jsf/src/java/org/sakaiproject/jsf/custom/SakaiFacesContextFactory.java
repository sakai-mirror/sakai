/**********************************************************************************
*
* $Header: /cvs/sakai/jsf/src/java/org/sakaiproject/jsf/custom/SakaiFacesContextFactory.java,v 1.11 2004/12/02 20:22:47 ggolden.umich.edu Exp $
*
***********************************************************************************
*
...
/**
 * <p>SakaiFacesContextFactory decorates the original FacesContext objects
 * to integrate with the CurrentService and also to persist FacesMessage 
 * objects across redirects (as needed for Sakai component use).</p>
 * 
