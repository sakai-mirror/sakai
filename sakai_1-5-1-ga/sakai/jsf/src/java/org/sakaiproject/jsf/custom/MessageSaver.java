/**********************************************************************************
*
* $Header: /cvs/sakai/jsf/src/java/org/sakaiproject/jsf/custom/MessageSaver.java,v 1.8 2004/11/09 03:42:54 janderse.umich.edu Exp $
*
***********************************************************************************
*
...
/**
 * <p>MessageSaver has utility methods to save FacesMessage objects
 * from one request to the next request (the messages are saved in 
 * the Sakai tool state).
 * @see SakaiFacesContextFactory
 * @see SakaiNavigationHandler
 * </p>
 * 
...
public class MessageSaver
{
	...
	public static void restoreMessages(FacesContext context)
	{
		...
		// JANDERSE - for compatibility with JSF applications that 
		// don't use Sakai stuff, don't NPE when state == null
