...
-- These are Oracle compatible commands.

-- $Header: /cvs/sakai/reference/src/sql/legacy/oracle/sakai_site_populate.sql,v 1.3 2005/02/17 14:32:44 zqian.umich.edu Exp $
