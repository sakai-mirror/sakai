...
description = "The site you requested is not available.">
<properties>
<property enc="BASE64" name="CHEF:creator" value="YWRtaW4=&#xa;"/>
<property enc="BASE64" name="CHEF:modifiedby" value="YWRtaW4=&#xa;"/>
<property enc="BASE64" name="DAV:getlastmodified" value="MjAwMzA2MjQxMjEwNTM1OTc=&#xa;"/>
...
@\dev\sakai\reference\src\sql\legacy\oracle\sakai_locks.sql
@\dev\sakai\reference\src\sql\legacy\oracle\sakai_alias.sql
@\dev\sakai\reference\src\sql\legacy\oracle\sakai_user.sql
@\dev\sakai\reference\src\sql\legacy\oracle\sakai_cluster.sql
...
-- to convert from pre Sakai 2.0.5
