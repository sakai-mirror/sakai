/**********************************************************************************
 *
 * $Header: /cvs/sakai/portal/src/java/org/sakaiproject/portal/varuna/VarunaServlet.java,v 1.21.2.4 2005/04/06 06:05:24 lance.indiana.edu Exp $
 *
 ***********************************************************************************
 *
...
public class VarunaServlet extends VmServlet
{
            ...
            throws ServletException
    {
        ...
        try
        {
            ...
            setVmReference("isUserSite", Boolean.valueOf(getSiteService().isUserSite(site.getId())), req);
