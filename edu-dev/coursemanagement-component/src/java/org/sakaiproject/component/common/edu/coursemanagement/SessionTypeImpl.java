...
public class SessionTypeImpl implements SessionType, Serializable {
	...
	private Date createdDate;
        ...
        public SessionTypeImpl(){}

        public SessionTypeImpl(String authority, String domain,
                               String keyword, String displayName,
                               String description, String uuid, Integer status, 
	...
	public boolean equals(Object rhs)
	{
		if (rhs == null)
			return false;
		if (! (rhs instanceof SessionTypeImpl))
			return false;
		SessionTypeImpl that = (SessionTypeImpl) rhs;
		if (this.getSessionTypeId() == null || that.getSessionTypeId() == null)
			return false;
		return (this.getSessionTypeId().equals(that.getSessionTypeId()));
	}
	...
	public int hashCode()
	{
		...
		{
			int result = 17;
			int sessionTypeIdValue = this.getSessionTypeId() == null ? 0 : this.getSessionTypeId().hashCode();
			result = result * 37 + sessionTypeIdValue;
