...
-- insert the new functions into the roles of any existing realm that has the role
...
--    join SAKAI_REALM_FUNCTION SRF on (TMP.FUNCTION_KEY = SRF.FUNCTION_KEY)
--    join SAKAI_REALM_ROLE SRR on (SRRFD.ROLE_KEY = SRR.ROLE_KEY)
