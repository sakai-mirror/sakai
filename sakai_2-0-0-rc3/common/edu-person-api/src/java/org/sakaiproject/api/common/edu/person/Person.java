/**********************************************************************************
 *
 * $Header: /cvs/sakai2/common/edu-person-api/src/java/org/sakaiproject/api/common/edu/person/Person.java,v 1.1 2005/05/10 21:23:24 lance.indiana.edu Exp $
 *
 ***********************************************************************************
 *
 ...
 * @version $Id: Person.java,v 1.1 2005/05/10 21:23:24 lance.indiana.edu Exp $
 */
public interface Person extends Persistable
{
  ...
  /**
   * @param agentUuid The UUID of the Agent for which this record describes.
   */
  ...
  /**
   * Common name. According to RFC 2256, "This is the X.500 commonName 
   * attribute, which contains a name of an object. If the object corresponds to 
   * a person, it is typically the person's full name.”
   * 
   * @return
   */
   ...
   * According to RFC 2256, "This attribute contains a human-readable 
   ...
   * object to which the entry corresponds, such as an address for package 
  ...
  /**
   * Office/campus phone number. Attribute values should follow the agreed 
