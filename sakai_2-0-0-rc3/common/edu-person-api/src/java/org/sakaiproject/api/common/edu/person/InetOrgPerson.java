/**********************************************************************************
 *
 * $Header: /cvs/sakai2/common/edu-person-api/src/java/org/sakaiproject/api/common/edu/person/InetOrgPerson.java,v 1.1 2005/05/10 21:23:24 lance.indiana.edu Exp $
 *
 ***********************************************************************************
 *
...
{
  /**
   * RFC 1274 notes that the proprietary format they recommend is "interim" 
   * only.
   * 
   * @return
   */
   ...
   * person. From RFC 2798 description: "preferred name of a person to be used 
  ...
  /**
   * From RFC 2256 description:" The givenName attribute is used to hold the 
   * part of a person's name which is not their surname nor middle name."
   * 
   * @return
   */
   ...
   * telephone number associated with a person.” Attribute values should follow 
   * the agreed format for international telephone numbers: i.e., 
   * "+44 71 123 4567."
   * 
   * @return
   */
  ...
  /**
   * Follow inetOrgPerson definition which refers to RFC 1274: "The manager 
   * attribute type specifies the manager of an object represented by an entry." 
   * The value is a DN.
   * 
   * @return
   */
   ...
   * specifies a mobile telephone number associated with a person. Attribute 
   * values should follow the agreed format for international telephone numbers: 
   * i.e., "+44 71 123 4567."
   * 
   * @return
   */
  ...
  /**
   * Standard name of the top-level organization (institution) with which this 
   ...
   * <p>
   * See RFC2068 and ISO 639 for allowable values in this field. Esperanto, for 
   * example is EO in ISO 639, and RFC2068 would allow a value of en-US for US 
   * English.
   * 
   * @return
   */
  ...
  /**
   * An X.509 certificate specifically for use in S/MIME applications (see RFCs 
   * 2632, 2633 and 2634).
   * 
   * @return
   */
