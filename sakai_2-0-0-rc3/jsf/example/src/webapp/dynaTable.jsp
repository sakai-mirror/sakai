...
<f:view>
<sakaix:view title="dynaTable tag - Sakai 2.0 JSF example">
...
<sakaix:dynaTable value="#{examplebean.list}" var="item"
   first="25" rows="25">
   <h:column>
     <h:outputText value=" #{item.last}, #{item.first}  #{item.address}" />
   </h:column>
   <sakaix:multiColumn value="#{item.grades}" var="grade">
   <h:column>
...
<pre>
  <font color="#000000">&lt;</font><font color="#000080">sakaix:dynaTable</font><font color="#000000"> </font><font color="#800000"><I>value</I></font><font color="#000000">=</font><font color="#0000ff">"#{examplebean.list}"</font><font color="#000000"> </font><font color="#800000"><I>var</I></font><font color="#000000">=</font><font color="#0000ff">"item"</font><font color="#000000">
   ...
   &lt;/</font><font color="#000080">h:column</font><font color="#000000">&gt;
   &lt;</font><font color="#000080">sakaix:multiColumn</font><font color="#000000"> </font><font color="#800000"><I>value</I></font><font color="#000000">=</font><font color="#0000ff">"#{item.grades}"</font><font color="#000000"> </font><font color="#800000"><I>var</I></font><font color="#000000">=</font><font color="#0000ff">"grade"</font><font color="#000000">&gt;
     &lt;</font><font color="#000080">h:column</font><font color="#000000">&gt;
     ...
     &lt;/</font><font color="#000080">h:column</font><font color="#000000">&gt;
   &lt;/</font><font color="#000080">sakaix:multiColumn</font><font color="#000000">&gt;
</font><font color="#000000">&lt;</font><font color="#000080">/sakaix:dynaTable</font></font>
</pre>
<hr />
</h:form>
</sakaix:view>
