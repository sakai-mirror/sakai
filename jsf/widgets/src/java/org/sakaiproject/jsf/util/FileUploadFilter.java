/**********************************************************************************
*
* $Header: /cvs/sakai2/jsf/widgets/src/java/org/sakaiproject/jsf/util/FileUploadFilter.java,v 1.3 2005/05/10 16:35:23 esmiley.stanford.edu Exp $
*
***********************************************************************************
*
  ...
  implements Filter {
   ...
   public void init(FilterConfig config) throws ServletException {
      repositoryPath = config.getInitParameter(
         "org.sakaiproject.jsf.util.FileUploadFilter.repositoryPath");
      try {
         String paramValue = config.getInitParameter(
            "org.sakaiproject.jsf.util.FileUploadFilter.sizeThreshold");
         if (paramValue != null)
            sizeThreshold = Integer.parseInt(paramValue);
         paramValue = config.getInitParameter(
            "org.sakaiproject.jsf.util.FileUploadFilter.sizeMax");
         if (paramValue != null)
