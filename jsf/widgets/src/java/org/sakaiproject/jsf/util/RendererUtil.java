...
public class RendererUtil
{
  ...
  /**
   * Return the attribute value - handles getting the value from
   * a ValueBinding if necessary.  This is necessary because of a
   * difference in the Sun JSF RI versus the MyFaces RI.  The
   * Sun RI component.getAttributes().get(attrName) will automatically
   * return value bindings, whereas the MyFaces implmentation
   * requires getting values from ValueBinding seperately.
   * @param context
   * @param component
   * @param name
   * @return
  ...
  */
  ...
  /**
   * @param attributeMap String key/value pairs
   * @param writer response writer
   */
  public static void writeAttributes(Map attributeMap,
   ...
   * singleton.
   *
   * @param gateKey for key value pair
   * @param gateValue value for key value pair for gatekeeper
   * @param contextBasePath the web app with the script
  ...
  {
    ResponseWriter writer = context.getResponseWriter();
    writeSmartExternalScripts(writer,
          gateKey, gateValue, contextBasePath, scriptPaths);
  }
   ...
   * @param collection
   * @param component
   * @return Map of String key/value pairs from a UIComponent for all keys in a collection
   */
  public static Map mapComponentAttributes(Collection collection, UIComponent component)
  {
    Map attributeMap = new HashMap();
    if (collection==null) return attributeMap;
...
*/
  public static Map mapComponentAttributes(String[] attributeNames, UIComponent component)
  {
    ...
    {
      attributeMap.put(attributeNames[i],
         (String) component.getAttributes().get(attributeNames[i]));
    }
    return attributeMap;
  }
   ...
   * @param rawSwitch String input string
   * @param supportOnOff boolean can input string be on, off?
   * @param supportTrueFalse boolean can input string be true, false?
   * @param supportYesNo boolean can input string be yes, no?
   * @param returnOnOff boolean output on, off instead of true false
   * @param returnYesNo boolean output yes, no instead of true false
   * @param defaultValue boolean if unknown, return true or false?
       * @return String raw swrich sring translated to correct switch value or default
   */
  public static String makeSwitchString(String rawSwitch,
   ...
   * @param out
   * @param items List of SelectItems
   * @param selected seelcted choice
   * @param clientId  the id
   * @param styleClass the optional style class
   * @param component the component being rendered
   * @throws IOException
   */

  public static void renderMenu(ResponseWriter out, List items, int selected,
...
//    if (true) return;
  ...
  public static String getFormId(FacesContext context, UIComponent component)
  {
    ...
    if (component instanceof UIForm) return ((UIForm)component).getId();
    return null;
  }
