	...
	<sakai:view_container title="#{msgs.title_edit}">
		<sakai:view_content>
			<h:form>
		  	...
		  	<sakai:tool_bar_message value="Edit Syllabus Item ......" /> 
...
<%--						<sakai:rich_text_area value="#{SyllabusTool.entry.entry.content}" columns="300" rows="70"/>--%>
...
<%--						<h:outputText value=""/>
						<h:commandButton action="#{SyllabusTool.processReadUpload}" value="Upload File"/>--%>
