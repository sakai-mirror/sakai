...
<%@ include file="../security/roleCheckStaticInclude.jsp"%>

<%@ page import="org.sakaiproject.service.legacy.user.cover.*" %>
  ...
  <h:panelGrid columnClasses="h1text,tdDisplay" width="90%"
    ...
    <h:panelGroup>
       ...
       <f:verbatim>Welcome, <%= UserDirectoryService.getCurrentUser().getDisplayName() %></f:verbatim>
