     ...
     <table align="{$tableAlign}" border="0" width="{$tableWidth}">
      ...
      <tr>
        <td colspan="2" align="left" valign="top" ><span class="form_label">Feedback delivery:</span><br/>
         ...
         <input name="{$FdbkXpath}" type="radio" value="IMMEDIATE">
        ...
        <br/>
        &#160;&#160;&#160;&#160;
         <input name="{$FdbkXpath}" type="radio" value="DATED">
        ...
        &#160;&#160;&#160;&#160; &#160;&#160;&#160;&#160;
          ...
          <input id="feedback_delivery_day" name="feedback_delivery_day" type="text">
            <xsl:attribute name="value">
              <xsl:value-of select="/stxx/form/assessmentActionForm/feedback_delivery_day"/>
            </xsl:attribute>
          </input>&#160; <a>
            <xsl:attribute name="href">javascript:cal4.popup("","<xsl:value-of select="concat($base,'html/')"/>");</xsl:attribute>
            <img alt="Click Here to Pick up the date" border="0" height="16" src="{$base}images/calendar/cal.gif" width="16"/>
          </a>
          <xsl:variable name="stHr" select="/stxx/form/assessmentActionForm/feedback_delivery_hours"/> &#160;&#160; 
          <select name="feedback_delivery_hours">
            ...
            <xsl:call-template name="minuteDropdown">
              <xsl:with-param name="mSelected">
                <xsl:value-of select="/stxx/form/assessmentActionForm/feedback_delivery_minutes"/>
              </xsl:with-param>
            </xsl:call-template>
          </select>    
        <br/>
        ...
        &#160;&#160;&#160;&#160;
          <input name="{$FdbkXpath}" type="radio" value="NONE">
