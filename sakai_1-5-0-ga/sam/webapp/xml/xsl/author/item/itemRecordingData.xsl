...
* <p>Description: ASI Author XML Style Sheet: Multimedia Audio</p>
...
* @version $Id: itemRecordingData.xsl,v 1.1.1.1 2004/07/28 21:32:09 rgollub.stanford.edu Exp $
-->
...
<xsl:template name="js_recording_variables">
 ...
 <!-- generated JavaScript (indent moved slightly to make more readable in target HTML)-->
		 // audio applet data for htmlarea audio popup
		  ...
		  var audioImageURL= 'jsp/aam/images';
</xsl:template>
</xsl:stylesheet>
