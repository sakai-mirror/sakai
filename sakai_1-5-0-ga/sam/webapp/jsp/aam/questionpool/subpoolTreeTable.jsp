...
<input type="button" value="Add"  onclick="document.location='<%=request.getContextPath()%>/startCreatePool.do?id=<%=questionpool.getCurrentPool().getId().toString()%>&use=createsub&pid=<%=questionpool.getCurrentPool().getId().toString()%>'">
</h2>
<div class="h2unit">
