...
<jsp:useBean id="questionReorder" scope="session" 
  class="org.navigoproject.ui.web.form.edit.QuestionReorderForm" />
<HTML>
<HEAD>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
<TITLE>Reorder Questions</TITLE>
...
<body>
<html:form action="/questionReorder.do" method="post">
...
<table width=100%>
<tr>
    <td><font FACE="arial,helvetica" SIZE=-2>Question Description</font></td>
    <td>&nbsp;</td>
</tr>

  <logic:iterate name="questionReorder" property="initialList" id="questionItem"
    type="org.navigoproject.business.entity.assessment.model.ItemImpl"
    indexId="ctr">
  <tr bgcolor=<%= (ctr.intValue()%2==0?"#E1E1E1":"#FFFFFF") %>>
    <td><font FACE="arial,helvetica" SIZE=-1><bean:write 
      name="questionItem" property="displayName" /></font></td>
    <td><html:select name="questionReorder" property='<%= "listAsArray[" + 
      ctr + "].data.position" %>' onchange="doMySubmit()">
      <html:options name="questionReorder" property="order"/> 
    </html:select></td>
  </tr>
  </logic:iterate>
...
<html:form  action="/cancelQuestionReorder.do" method="post">
<html:submit value="  Cancel "property="submitit" />
</html:form>
</body>
</HTML>
