...
<!-- $Id: authorIndex.jsp,v 1.63.2.2 2005/02/22 18:08:31 rgollub.stanford.edu Exp $ -->
  <f:view>
...
onclick=
"window.open( '../qti/importAssessment.faces','_qti_import', 'toolbar=no,menubar=no,personalbar=no,width=650,height=375,scrollbars=no,resizable=yes');"
 />
