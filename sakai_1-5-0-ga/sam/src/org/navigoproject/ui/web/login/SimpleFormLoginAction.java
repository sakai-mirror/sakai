 ...
 * @version $Id: SimpleFormLoginAction.java,v 1.1.1.1 2004/07/28 21:32:08 rgollub.stanford.edu Exp $
 */
public class SimpleFormLoginAction
  extends Action
{
  private static final org.apache.log4j.Logger LOG =
    org.apache.log4j.Logger.getLogger(SimpleFormLoginAction.class);
    ...
    HttpServletResponse response)
  {
    ...
    SimpleFormLoginActionForm form = (SimpleFormLoginActionForm) actionForm;
    ActionErrors errors = new ActionErrors();

    if(this.validateUsernamePassword(form.getUsername(), form.getPassword()))
    {
      LOG.debug("return forward to NAVIGATION");
  ...
  private boolean validateUsernamePassword(String username, String password)
  {
    ...
    {
      LOG.debug(
        "validateUsernamePassword(String " + username + ", String " +
