 ...
 * Window&gt;Preferences&gt;Java&gt;Code Generation&gt;Code and Comments
 */
public class DeleteAssessmentAction extends Action
{
  /**
   *
   */
	private static final org.apache.log4j.Logger LOG =
		org.apache.log4j.Logger.getLogger(DeleteAssessmentAction.class); 
		 ...
		 HttpServletResponse response)
	 {
		...
		if(action != null && (action.equals("Delete") || action.equals("Remove")))
		{
			String assessmentID = request.getParameter("assessmentID");
			 if(assessmentID != null)
			 {
		assessmentHelper.deleteAssesment(assessmentID);
			 }
		}
