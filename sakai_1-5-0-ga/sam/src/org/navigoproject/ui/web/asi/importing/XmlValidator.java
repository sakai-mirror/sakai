 ...
 *
 * @author $author$
 * @version $Id: XmlValidator.java,v 1.1.1.1 2004/07/28 21:32:07 rgollub.stanford.edu Exp $
 */
public class XmlValidator
{
   ...
   * DOCUMENTATION PENDING
   *
   * @param filePath DOCUMENTATION PENDING
   *
    ...
    throws SAXException, IOException
  {
    ...
    {
      LOG.debug("validate(String " + filePath + ")");
    }
