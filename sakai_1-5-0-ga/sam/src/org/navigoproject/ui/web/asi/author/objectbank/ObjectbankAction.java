 ...
 */
package org.navigoproject.ui.web.asi.author.objectbank;
 ...
 *
 * @author $author$
 * @version $Id: ObjectbankAction.java,v 1.1.1.1 2004/07/28 21:32:07 rgollub.stanford.edu Exp $
 */
public class ObjectbankAction
  extends Action
{
  private static final org.apache.log4j.Logger LOG =
    org.apache.log4j.Logger.getLogger(ObjectbankAction.class);
    ...
    HttpServletResponse response)
  {
    ...
    try
    {
      ...
      {
        if(request.getSession().getAttribute("bankXml") != null)
        {
          ;
        }
        ...
        InputStream inputStream =
          this.servlet.getServletContext().getResourceAsStream(
            filePath + "objectBankTemplate.xml");
        xmlString = authoringHelper.readXMLDocument(inputStream);

        //	authoringHelper.sessionSetup(xmlString,  request, "set", "bankXml");
        // replace with code
        findForward = "bankMain";
      }
      else
      {
    ...
    LOG.debug("Forwarding to : " + findForward);
