...
/**
 * This interface simplifies the media process in the action class.
 *
...
public interface MediaInterface
{
   ...
   * DOCUMENTATION PENDING
   *
   * @param collection DOCUMENTATION PENDING
   */
  public void setMediaCollection(Collection collection);
   ...
   * @param collection DOCUMENTATION PENDING
   */
  public void setRelatedMediaCollection(Collection collection);
}
