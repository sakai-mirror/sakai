 ...
 * @version 1.0
 */
public class ItemTemplateIteratorImpl
  implements ItemTemplateIterator
{
  private Iterator items;

  /**
   * Creates a new ItemTemplateIteratorImpl object.
   *
   * @param pitems DOCUMENTATION PENDING
   */
  public ItemTemplateIteratorImpl(Collection pitems)
  {
    items = pitems.iterator();
  }
   ...
   */
  public ItemTemplate next()
    throws AssessmentException
  {
    try
    {
      return (ItemTemplate) items.next();
    }
    catch(Exception e)
    {
