 ...
 * @version 1.0
 */
public class SectionTemplateIteratorImpl
  implements SectionTemplateIterator
{
  private Iterator sections;

  /**
   * Creates a new SectionTemplateIteratorImpl object.
   *
   * @param psections DOCUMENTATION PENDING
   */
  public SectionTemplateIteratorImpl(Collection psections)
  {
   ...
   */
  public SectionTemplate next()
    throws AssessmentException
  {
    try
    {
      return (SectionTemplate) sections.next();
    }
    catch(Exception e)
    {
