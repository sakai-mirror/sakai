 ...
 *
 * @author Ed Smiley
 * @version $Id: StandardDate.java,v 1.1.1.1 2004/07/28 21:32:06 rgollub.stanford.edu Exp $
 */
public class StandardDate
{
  private static final org.apache.log4j.Logger LOG =
    org.apache.log4j.Logger.getLogger(StandardDate.class);
   ...
   */
  private static final String STANDARD_FORMAT = "EEE MMM d, yy KK:mm aa";
  private Date date;
   ...
   */
  public StandardDate(Date pdate)
  {
    date = pdate;
  }
  ...
  public String toString()
  {
    try
    {
      SimpleDateFormat dateFormatter = new SimpleDateFormat(STANDARD_FORMAT);
  ...
  {
    Date d = new Date();
    StandardDate sd = new StandardDate(d);
    LOG.debug("debug: " + sd);
  }
}
