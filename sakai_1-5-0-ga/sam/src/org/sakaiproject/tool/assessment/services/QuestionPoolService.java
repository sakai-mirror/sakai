...
import org.sakaiproject.tool.assessment.osid.questionpool.impl.QuestionPoolIteratorImpl;
...
//DELETEME
  ...
  public void addItemsToSection(Collection ids, osid.shared.Id sectionId)
  {
    try
    {
//TODO must call the Service.
   ...
   */
    /**
  public QuestionPoolFacade createPool(Id parentPoolId)
  {
    try
    {
//TODO must call the Service.
...
//TODO must call the Service.
   ...
   */
    /**
  public QuestionPoolFacade importQuestionPool(InputStream inputStream)
  {
    try
    {
   ...
   */
    /**
  public String exportQuestionPool(QuestionPoolFacade pool)
  {
    try{
...
//      throw new Error(e);
  ...
  public Collection selectNrandomQuestions(
    QuestionPoolFacade pool, int n, Agent agent)
  {
    try
    {
