 ...
 *
 * @author $author$
 * @version $Id: QuestionPoolTreeImpl.java,v 1.3 2004/10/06 20:56:01 daisyf.stanford.edu Exp $
 */
...
//      throw new Error(e);
   ...
   */
  public String getCurrentObjectHTMLId(QuestionPool pool)
  {
    try
    {
      setCurrentId(pool.getId());
      QuestionPool current = (QuestionPool) getCurrentObject();
...
//      throw new Error(e);
   ...
   * 2 is first level child, etc..
   */
  public String getCurrentLevel(QuestionPool pool)
  {
    int index1 = 1;
    try
    {
