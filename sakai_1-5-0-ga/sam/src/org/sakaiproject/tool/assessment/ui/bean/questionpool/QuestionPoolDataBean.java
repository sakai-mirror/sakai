  ...
  implements Serializable
{
  ...
  private static Logger LOG =
    Logger.getLogger(QuestionPoolDataBean.class.getName());
  ...
  {
    LOG.debug("Set form name: " + newName);
    displayName = newName;
  }
  ...
  {
    LOG.debug("Set form owner: " + param);
    owner= param;
  }
  ...
  {
    LOG.debug("Set form organizationName: " + param);
  ...
  {
    LOG.debug("Set form keywords: " + param);
    keywords= param;
  }
  ...
  {
    LOG.debug("Set form objectives: " + param);
    objectives = param;
  }
