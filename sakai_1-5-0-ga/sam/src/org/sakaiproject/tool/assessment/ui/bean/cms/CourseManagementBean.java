 ...
 * <p> </p>
 * @author Ed Smiley
 * @version $Id: CourseManagementBean.java,v 1.1 2004/11/18 01:44:05 esmiley.stanford.edu Exp $
 */
...
public class CourseManagementBean implements Serializable
{
  ...
  public CourseManagementBean(){
    courseName = "Sakai Assessment Manager Samigo Demo Course";
    courseIdString = "SAM101";
