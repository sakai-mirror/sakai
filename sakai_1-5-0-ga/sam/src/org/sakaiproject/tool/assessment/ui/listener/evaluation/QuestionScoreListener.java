 ...
 * @author Ed Smiley
 * @version $Id: QuestionScoreListener.java,v 1.18.2.1 2005/02/17 05:05:38 rgollub.stanford.edu Exp $
 */

public class QuestionScoreListener
  implements ActionListener, ValueChangeListener
{
  static Logger LOG = Logger.getLogger(QuestionScoreListener.class.getName());
