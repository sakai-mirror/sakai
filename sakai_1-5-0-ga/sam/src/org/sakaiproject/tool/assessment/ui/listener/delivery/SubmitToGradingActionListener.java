 ...
 * @version $Id: SubmitToGradingActionListener.java,v 1.19.2.3 2005/02/18 04:12:51 daisyf.stanford.edu Exp $
 */

public class SubmitToGradingActionListener implements ActionListener
{
  static Logger LOG = Logger.getLogger(SubmitToGradingActionListener.class.
                      getName());
    ...
    AbortProcessingException
  {
    try {
      ...
      if (cu.lookupParam("showfeedbacknow") != null &&
          cu.lookupParam("showfeedbacknow").equals("true"))
