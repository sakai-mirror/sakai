 ...
 * @version $Id: ItemModifyListener.java,v 1.15.2.1 2005/02/18 03:45:28 rgollub.stanford.edu Exp $
 */

public class ItemModifyListener implements ActionListener
{
 static Logger LOG = Logger.getLogger(ItemModifyListener.class.getName());
  ...
  public boolean populateItemBean(ItemAuthorBean itemauthorbean, String itemId) {
    ...
    System.out.println("lydiatest set multiplecorr string : " + bean.getMultipleCorrectString());
                        ...
                        break;
                case 3:
                        itemauthorbean.setItemTypeString("Multiple Choice Survey");  // need to get it from properties file
                        nextpage = "surveyItem";
                        break;
                case 4:
