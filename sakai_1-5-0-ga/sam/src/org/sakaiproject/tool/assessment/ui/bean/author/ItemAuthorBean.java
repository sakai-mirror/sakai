 ...
 * $Id: ItemAuthorBean.java,v 1.29 2005/02/12 09:16:45 lydial.stanford.edu Exp $
 */
public class ItemAuthorBean
  implements Serializable
{
  private static final org.apache.log4j.Logger LOG =
    org.apache.log4j.Logger.getLogger(ItemAuthorBean.class);
...
//  private String itemId;
  ...
  {
    LOG.debug("Constructor ItemAuthorBean()");
...
// TODO use sectionBean.getsectionNumberList when its ready
  ...
  public ArrayList getSectionSelectList() {
    ...
    while (iter.hasNext()){	
      ...
      SelectItem selection = new SelectItem();
      selection.setLabel(part.getTitle());
...
// never really use this, put here for completeness
			...
			break;
		case 3:
			this.setItemTypeString("Multiple Choice Survey");  //  need to get it from properties file
			nextpage = "surveyItem";
			break;
		case 4:
