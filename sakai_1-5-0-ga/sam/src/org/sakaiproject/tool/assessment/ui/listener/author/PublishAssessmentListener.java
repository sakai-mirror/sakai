 ...
 * @author Ed Smiley
 * @version $Id: PublishAssessmentListener.java,v 1.9.2.1 2005/02/17 16:07:26 daisyf.stanford.edu Exp $
 */
...
public class PublishAssessmentListener
  ...
  public void processAction(ActionEvent ae) throws AbortProcessingException {
    ...
    ArrayList inactivePublishedList = publishedAssessmentService.
        ...
        author.getInactivePublishedAssessmentOrderBy());
  ...
  private void publish(AssessmentFacade assessment,
    ...
    PublishedAssessmentService publishedAssessmentService = new
        PublishedAssessmentService();
    PublishedAssessmentFacade pub = publishedAssessmentService.
