/**********************************************************************************
*
* $Header: /cvs/sakai/service/src/java/org/sakaiproject/service/legacy/resource/Reference.java,v 1.16 2005/01/03 20:21:01 ggolden.umich.edu Exp $
*
***********************************************************************************
*
	...
	public ResourceProperties getProperties()
	{
		...
		else if (m_type.equals(DissertationService.SERVICE_NAME))
		{
			try
			{
				...
				else Log.warn("chef", this + ".getProperties(): unknown dissertation ref subtype: " + m_subType + " in ref: " + m_reference);
			}
			catch (PermissionException e) {Log.warn("chef", this + "getProperties(): " + e);}
			catch (IdUnusedException e)
			{
