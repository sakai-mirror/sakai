/**********************************************************************************
*
* $Header: /cvs/sakai/service/src/java/org/sakaiproject/service/legacy/presence/cover/PresenceService.java,v 1.10 2004/09/30 20:20:56 ggolden.umich.edu Exp $
*
***********************************************************************************
*
...
public class PresenceService
{
	...
	public static java.lang.String[] parseLocation(java.lang.String param0)
	{
		org.sakaiproject.service.legacy.presence.PresenceService service = getInstance();
		if (service == null)
			return null;

		return service.parseLocation(param0);
	}
