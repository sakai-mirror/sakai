/**********************************************************************************
*
* $Header: /cvs/sakai/provider/src/java/org/sakaiproject/component/legacy/realm/SampleRealmProvider.java,v 1.5 2004/12/17 03:57:27 ggolden.umich.edu Exp $
*
***********************************************************************************
*
...
/**
* <p>Sample of a RealmProvider.  Shows how to handle compound ids (connected with a '+').</p>
* 
	...
	implements RealmProvider
{
	...
	*/
	...
	protected void update()
	{
		...
		try
		{
			m_usersx.load(new FileInputStream("/usr/local/sakai/provider/users.properties"));
		}
		catch (Exception e)
		{
			// m_logger.warn(this + ".update: reading users.properties: " + e);
		}
	}
}
