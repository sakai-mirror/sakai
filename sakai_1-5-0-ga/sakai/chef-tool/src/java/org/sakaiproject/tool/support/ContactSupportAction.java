/**********************************************************************************
*
* $Header: /cvs/sakai/chef-tool/src/java/org/sakaiproject/tool/support/ContactSupportAction.java,v 1.12 2005/02/11 21:21:59 janderse.umich.edu Exp $
*
***********************************************************************************
*
...
public class ContactSupportAction extends VelocityPortletPaneledAction
{
	...
	public void doSend(RunData runData, Context context)
	{
		...
		*/
		...
		+ "Site Title: " + worksiteTitle + "\n"
		+ "Site Id: " + PortalService.getCurrentSiteId() + "\n"
		+ "site URL: " + worksiteURL + "\n\n";
		
		String helpEmail = ServerConfigurationService.getString("support.email",null);
		
		if (helpEmail == null)
		{
			addAlert(state, "Support email address has not been specified. ");
		}
		else
		{
