/**********************************************************************************
*
* $Header: /cvs/sakai/chef-tool/src/java/org/sakaiproject/tool/assignment/AssignmentAction.java,v 1.42 2005/02/11 21:22:00 janderse.umich.edu Exp $
*
***********************************************************************************
*
...
extends NewPagedResourceAction
{
	...
	{		
		...
		String contextString = (String) state.getAttribute (STATE_CONTEXT_STRING);
		context.put("allowAddNewAssignment", new Boolean(AssignmentService.allowAddAssignment (contextString)));
		context.put("allowGradeAssignment", new Boolean(AssignmentService.allowGradeSubmission (contextString)));
																...
																SessionState state)
	{
		...
		String stateContext = (String) state.getAttribute(STATE_CONTEXT_STRING);
		if (AssignmentService.allowAddAssignment(stateContext))
		{
	...
	public void doNew_assignment (RunData data, Context context)
	{
		...
		{
			addAlert(state, "You are not allowed to add new assignments.");
			state.setAttribute(STATE_MODE, MODE_INSTRUCTOR_LIST_ASSIGNMENTS);
		}
