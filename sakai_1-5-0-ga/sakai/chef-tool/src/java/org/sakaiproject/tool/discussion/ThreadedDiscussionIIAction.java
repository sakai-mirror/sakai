/*********************************************************************************
*
* $Header: /cvs/sakai/chef-tool/src/java/org/sakaiproject/tool/discussion/ThreadedDiscussionIIAction.java,v 1.30 2005/02/11 21:22:00 janderse.umich.edu Exp $
*
***********************************************************************************
*
	...
	**/	
	...
	public void doDelete_category ( RunData data, Context context )
	{
		...
		try
		{
			...
			{
				String messageId = ((DiscussionMessage) messages.next()).getId();
				channel.removeMessage(channel.editDiscussionMessage(messageId));
				if (currentMessageId != null && messageId.equals(currentMessageId))
				{
					// remove state attribute for current display message
					state.removeAttribute(STATE_DISPLAY_MESSAGE);
				}
			}
