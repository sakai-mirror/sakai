/**********************************************************************************
*
* $Header: /cvs/sakai/chef-tool/src/java/org/sakaiproject/tool/courier/Courier.java,v 1.21 2004/12/16 22:14:31 ggolden.umich.edu Exp $
*
***********************************************************************************
*
...
//		long startTime = System.currentTimeMillis();
		...
		if (session != null)
		{
			...
			if (locationParsed[2] == null)
			{
				// see if we have "tool" parameters
				boolean hasToolParams = false;
				ParameterParser params = (ParameterParser) req.getAttribute(ATTR_PARAMS);
				if (params != null)
				{
					String[] toolIds = params.getStrings("tool");
					if (toolIds != null)
					{
						hasToolParams = true;
						for (int i = 0; i < toolIds.length; i++)
						{
							...
							String toolLocation =
								PresenceService.locationId(locationParsed[0], locationParsed[1], toolIds[i]);
		...
		// set the default skin to forstall any site based skin query
		...
		setVmReference("sakai_skin", skinRoot + skin, req);
