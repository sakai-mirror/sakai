/**********************************************************************************
*
* $Header: /cvs/sakai/jsf/src/java/org/sakaiproject/jsf/renderer/TitleBar.java,v 1.6 2005/01/27 15:32:51 casong.indiana.edu Exp $
*
***********************************************************************************
*
...
public class TitleBar extends Renderer
{
	...
	public void encodeBegin(FacesContext context, UIComponent component) throws IOException
	{
		...
		writer.write("<td class=\"chefActionTitleStyleClass\" align=\"right\">");
		String helpDocId = (String) component.getAttributes().get("helpDocId");
		if(helpDocId != null && ServerConfigurationService.getBoolean("helpEnabled", false))
		{
			...
			linkToHelp += "<img src=\"/tunnel/sakai-chef-tool/image/help.gif\" border=\"0\"></a>";
