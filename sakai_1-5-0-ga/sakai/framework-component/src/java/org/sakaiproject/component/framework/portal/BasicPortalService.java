/**********************************************************************************
*
* $Header: /cvs/sakai/framework-component/src/java/org/sakaiproject/component/framework/portal/BasicPortalService.java,v 1.19 2004/11/04 00:34:11 ggolden.umich.edu Exp $
*
***********************************************************************************
*
	...
	implements PortalService
{
	...
	*/
	...
	{
		// a tool from a request "pid" might be stored in the request attribute "sakai.wrapper.tool" (cheftool)
		HttpServletRequest req = (HttpServletRequest) m_currentService.getInThread(HttpServletRequest.class.getName());
		ToolConfiguration tool = (ToolConfiguration) req.getAttribute("sakai.wrapper.tool");
		if (tool != null)
		{
