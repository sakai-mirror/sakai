/**********************************************************************************
*
* $Header: /cvs/sakai/framework-component/src/java/org/sakaiproject/component/framework/memory/BasicMemoryService.java,v 1.23 2004/10/07 01:57:37 ggolden.umich.edu Exp $
*
***********************************************************************************
*
...
/**
* <p>MemoryService is an implementation for the CHEF MemoryService which reports memory usage and
...
public class BasicMemoryService implements MemoryService, Observer
{
	...
	*******************************************************************************/
	 ...
	 */
	public void setCacheLogging(String value)
	{
		m_cacheLogging = new Boolean(value).booleanValue();
	}
	...
	*******************************************************************************/
	...
	public void init()
	{
		try
		{
			// look for a configuration override of the smtp
			m_cacheLogging = m_serverConfigurationService.getBoolean("verbose.cache", m_cacheLogging);
