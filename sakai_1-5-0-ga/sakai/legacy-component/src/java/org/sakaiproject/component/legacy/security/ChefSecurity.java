/**********************************************************************************
*
* $Header: /cvs/sakai/legacy-component/src/java/org/sakaiproject/component/legacy/security/ChefSecurity.java,v 1.14 2005/01/25 04:40:49 ggolden.umich.edu Exp $
*
***********************************************************************************
*
...
public class ChefSecurity
	implements SecurityService, CacheRefresher
{
	...
	*******************************************************************************/
	...
	public void init()
	{
		...
		m_cacheMinutes = m_serverConfigurationService.getInt("security.cache.minutes", m_cacheMinutes);
