/**********************************************************************************
*
* $Header: /cvs/sakai/legacy-component/src/java/org/sakaiproject/component/legacy/email/XmlFileMailArchiveService.java,v 1.10 2004/11/08 03:50:27 ggolden.umich.edu Exp $
*
***********************************************************************************
*
...
/**
* <p>XmlFileMailArchiveService fills out the BaseMailArchiveService with a in-memory xml file backed up
...
*/
public class XmlFileMailArchiveService
	extends BaseMailArchiveService
{
	/** A full path and file name to the storage file. */
	protected String m_storagePath = "db/mailarchive.xml";
	...
	*******************************************************************************/
	...
	/**
	* Covers for the BaseXmlFileStorage, providing MailArchive parameters
	*/
		...
		implements Storage
	{
		...
		*/
		...
		{
			super(m_storagePath, "mailarchive", "channel", "message", user);
