/**********************************************************************************
*
* $Header: /cvs/sakai/legacy-component/src/java/org/sakaiproject/component/legacy/assignment/BaseAssignmentService.java,v 1.50 2004/12/18 23:33:51 zqian.umich.edu Exp $
*
***********************************************************************************
*
												...
												if (child5.getNodeType() == Node.ELEMENT_NODE)
												{
													...
													if (element5.getTagName().equals("attachment"))
													{
														...
														// filter out the invalid characters in the attachment id
													   	String oldUrl = Validator.escapeQuestionMark(element5.getAttribute("relative-url"));
