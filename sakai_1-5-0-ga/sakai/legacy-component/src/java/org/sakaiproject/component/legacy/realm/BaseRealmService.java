/**********************************************************************************
*
* $Header: /cvs/sakai/legacy-component/src/java/org/sakaiproject/component/legacy/realm/BaseRealmService.java,v 1.29 2005/02/10 20:09:52 ggolden.umich.edu Exp $
*
***********************************************************************************
*
	...
	*******************************************************************************/
		...
		throws IdUnusedException, PermissionException, InUseException
	{
		...
		if (	(!StringUtil.different(maintainRole, grant.getRole().getId()))
			&&	(	(StringUtil.different(maintainRole, joinerRole))
				||	(!site.isJoinable())))
		{
			cancelEdit(edit);
			throw new PermissionException(user, SECURE_UPDATE_OWN_REALM, SiteService.siteReference(siteId));
