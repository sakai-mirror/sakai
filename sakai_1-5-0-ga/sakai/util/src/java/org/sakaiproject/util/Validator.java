/**********************************************************************************
*
* $Header: /cvs/sakai/util/src/java/org/sakaiproject/util/Validator.java,v 1.14 2004/12/22 04:08:42 janderse.umich.edu Exp $
*
***********************************************************************************
*
...
//	protected static final String ESCAPE_URL = "#%?&='\"+ ";
	...
	*/
	...
	/** 
	 * <xmp>Escape HTML-formatted text in preparation to include it in an HTML document,
	 * except that HTML line breaks ("<br />") will be supressed (removed).</xmp>
	 */
	...
	*/
	...
	/**
	* <xmp>Limit the formatted to a certain number of DISPLAYED characters, adding "..." if it was truncated.
