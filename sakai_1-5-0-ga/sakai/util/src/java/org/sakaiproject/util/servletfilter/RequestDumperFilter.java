/**********************************************************************************
*
* $Header: /cvs/sakai/util/src/java/org/sakaiproject/util/servletfilter/RequestDumperFilter.java,v 1.3 2005/01/10 22:00:11 janderse.umich.edu Exp $
*
***********************************************************************************
*
...
public final class RequestDumperFilter implements Filter {
    ...
    /** Whether this filter is currently active (dumping requests)*/
    ...
    // parse the dumpRequest parameter - if "true", subsequent requests will 
    // be dumped to the servlet log.  If "false", subsequent requests will no 
    // longer be logged.
    String active = request.getParameter("dumpRequest");
    if (active != null)
    {
    ...
    if (!m_active)
    {
        // the filter isn't active, so it just passes on control without doing anything...
    ...
    public void init(FilterConfig filterConfig) throws ServletException {
	    ...
	    if (active != null)
	    {
	        m_active = Boolean.getBoolean(active);
	    }
    }
