/**********************************************************************************
*
* $Header: /cvs/sakai/util/src/java/org/sakaiproject/util/FormattedText.java,v 1.22 2004/12/22 04:08:33 janderse.umich.edu Exp $
*
***********************************************************************************
*
...
public class FormattedText
{
	 ...
	 * @param replaceWhitespaceTags <xmp>If true, clean up line breaks to be like "<br />".</xmp>
	...
	/** 
	 * <xmp>Prepares the given HTML formatted text for output as part of an HTML document,
	 * removing newlines ("<br />").</xmp>
	 * @param value The formatted text to output in an HTML document.
	 * @return The string to include in an HTML document.
	 */
	 ...
	 * @param supressNewlines <xmp>If true, remove newlines ("<br />") when escaping.</xmp>
	 * @return The string to include in an HTML document.
	 */
	...
	/**
	* <xmp>Escape the given value so that it appears as-is in HTML - that is,
	* HTML meta-characters like '<' are escaped to HTML character entity
	* references like '&lt;'.</xmp>
	* Markup, amper, quote are escaped.  Whitespace is not. 
	* @param value The string to escape.
	* @param escapeNewlines <xmp>Whether to escape newlines as "<br />\n" so that they appear as HTML line breaks.</xmp>
	...
	*/
	...
	/**
	 * <xmp>Converts the given HTML formatted text to plain text - loses formatting information.
	 * For example, The formatted text "Hello <br /><b>World!</b>" becomes plain text "Hello \nWorld!"
	 * Strips all formatting information from the formatted text</xmp>
