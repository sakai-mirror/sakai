/**********************************************************************************
 *
 * $Header: /cvs/sakai2/test/comp-test-components1/src/java/org/sakaiproject/component/test/components/Component3.java,v 1.3 2005/03/07 04:16:34 ggolden.umich.edu Exp $
 *
 ***********************************************************************************
 *
...
public class Component3 implements Api3
{
	...
	{
		m_counter++;
		return "Component3/comp1: " + m_config + " (" + m_counter
				+ ") - my Api5: " + m_s5;
	}
}
