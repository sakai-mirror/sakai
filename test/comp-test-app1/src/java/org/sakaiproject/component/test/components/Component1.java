/**********************************************************************************
 *
 * $Header: /cvs/sakai2/test/comp-test-app1/src/java/org/sakaiproject/component/test/components/Component1.java,v 1.3 2005/03/07 04:16:33 ggolden.umich.edu Exp $
 *
 ***********************************************************************************
 *
...
public class Component1 implements Api1
{
	...
	{
		m_counter++;
		return "Component1/app1: " + m_config + " (" + m_counter + ")";
	}
}
